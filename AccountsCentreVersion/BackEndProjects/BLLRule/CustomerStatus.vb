...
Public Class CustomerStatus
    ...
    ByVal Code As String, ByVal ProStartdate As String, ByVal ProEnddate As String, ByVal PlanStartdate As String,ByVal PlanEnddate As String, ByVal StartInterval As String, ByVal EndInterval As String, ByVal chkBit As Boolean, ByVal connData As ConnectionData) As String
        Try
            Dim cmd As New CommandData(connData.CustomerID)
            If chkBit = True Then
  ...
  ByVal Code As String, ByVal connData As ConnectionData) As String
    ...
    Public Shared Function UpdateEntity(ByVal Analysisid As String, ByVal MeterName As String, ByVal Planid As String, ByVal CriteriaId As String, _
    ByVal ClipType As String, ByVal EntityName As String, ByVal EntityId As String, ByVal Clip As String, ByVal LargeClip As String, ByVal Code As String, ByVal ProStartdate As String, ByVal ProEnddate As String, ByVal PlanStartdate As String, ByVal PlanEnddate As String, ByVal StartInterval As String, ByVal EndInterval As String, ByVal chkBit As Boolean, ByVal connData As ConnectionData) As String
        Try
            Dim cmd As New CommandData(connData.CustomerID)
            If chkBit = True Then
                If StartInterval = "" Then StartInterval = Format(Date.Now, "dd MMM yyyy")
            ...
            End If
            cmd.CmdText = "BPL_UpdateMeterInfr1"
            cmd.AddParameter("@Analysisid", Analysisid)
            cmd.AddParameter("@MeterName", MeterName)
            cmd.AddParameter("@Planid", Planid)
            cmd.AddParameter("@CriteriaId", CriteriaId)
...
'    Public Shared Function DeleteEntity(ByVal Planid As String, ByVal AnalysisId As String) As String
'        Try
...
'            Dim ds As DataSet
'            Dim cmd As New CommandData(connData.CustomerID)
'            cmd.CmdText = "BPL_GetClipByPlanid" ' ""BPL_GetClipByPlanid"
'            cmd.AddParameter("@Planid", Planid)
'            ds = CType(cmd.Execute(ExecutionType.ExecuteDataSet), DataSet)
'            Return ds
'        Catch ex As Exception
