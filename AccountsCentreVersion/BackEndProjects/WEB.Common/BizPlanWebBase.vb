    ...
    Public Overridable ReadOnly Property Navigator() As String() Implements IBizPlanWebBase.Navigator
        Get
            ...
            If GetProWebCustomer = True Then
                mainNavigator = New String() {"Home", "Plan Manager", "Speedometer Manager", "Exported Plans", "FAQs"}

            Else
                mainNavigator = New String() {"Home", "Plan Manager", "Exported Plans", "FAQs"}
...
#End Region
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        Try
            ...
            CommonBase.SendEmail(ConfigReader.GetItem(ConfigVariables.SMTPUserID), "bizplan.errors@accountscentre.com", "Accountscentre Administration", body, Mail.MailFormat.Html)
