									...
									<td width="40%" bgcolor="#edf3f8">
										...
										<table width="100%" height="36%" border="0" align="center" cellpadding="0" cellspacing="2"
											...
											<tr valign="top" bgcolor="#fbfbfb">
												...
												<td width="66%"><asp:textbox id="txtuserid" runat="server" width="150px" cssclass="mtbox" maxlength="250"></asp:textbox></td>
											</tr>
											<tr valign="top" bgcolor="#fbfbfb">
												<td><b>Password</b></td>
												<td><asp:textbox id="txtpassword" runat="server" width="150px" cssclass="mtbox" maxlength="50" textmode="Password"></asp:textbox></td>
											</tr>
											<tr valign="top" bgcolor="#fbfbfb">
												<td height="24">&nbsp;</td>
												<td bgcolor="#fbfbfb">
