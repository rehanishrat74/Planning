...
<%@ Page Language="vb" autoeventwireup="false" codebehind="forgotpassword.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.ForgotPassword" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Accounts Centre - Forgot Password</title>
								...
								<tbody>
									<tr valign="top">
										...
										<td width="50%" bgcolor="#edf3f8">
												...
												<tbody>
													<tr>
														<td valign="top" style="WIDTH: 323px">
															<strong>Sign-in Problem</strong></td>
													</tr>
													<tr>
														<td valign="top" style="WIDTH: 323px">
														</td>
													...
													<tr>
														<td valign="top" style="WIDTH: 323px; HEIGHT: 62px">
															<p>
																If you've forgotten the password to your account, please enter your email 
																address that you have entered at the time of registration&nbsp;and press the 
																Forgot Password button. We will send you the password at your given email 
																address.
															</p>
														</td>
													</tr>
											...
											<P>&nbsp;</P>
											<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<asp:LinkButton id="lnkbtnSign" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small">Sign In</asp:LinkButton></P>
										</td>
												...
												<TABLE style="WIDTH: 286px; HEIGHT: 61px" width="286">
													...
													<TR>
														<TD style="HEIGHT: 19px" align="center">
															<asp:Button id="btnBack" runat="server" Text="Back" cssclass="acc_mbutton" onmouseover="this.className='acc_mbuttonon';" onmouseout="this.className='MBUTTON';"></asp:Button></TD>
													</TR>
													<TR>
											...
											<asp:Panel id="pnlBody" runat="server" Width="292px" Height="147px" BackColor="#EDF3F8">
												<TABLE class="content" style="WIDTH: 291px; HEIGHT: 150px" height="150" cellSpacing="5"
													...
													<TR vAlign="top" bgColor="#fbfbfb">
														<TD style="HEIGHT: 11px" width="50%" bgColor="#edf3f8" colSpan="1" rowSpan="1"><B>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
																&nbsp;<FONT class="Error"> &nbsp;*</FONT></B></TD>
													...
													<TR>
														<TD style="WIDTH: 90px; HEIGHT: 13px" height="13"><B>Surname&nbsp;&nbsp;&nbsp;&nbsp;<FONT class="Error">&nbsp;*</FONT></B></TD>
													...
													<TR>
														<TD style="WIDTH: 90px; HEIGHT: 13px" height="13"><B>First Name&nbsp;<FONT class="Error">&nbsp;*</FONT></B></TD>
													...
													<TR>
														<TD style="WIDTH: 90px; HEIGHT: 18px" height="18"><B>Second Name </B>
														</TD>
													...
													<TR vAlign="top" bgColor="#fbfbfb">
														...
														<TD style="HEIGHT: 18px" vAlign="top" align="left" bgColor="#edf3f8">
															<asp:button id="btnForgotPassword" onmouseover="this.className='MBUTTONON';" onmouseout="this.className='MBUTTON';"
																runat="server" Font-Bold="True" Width="106px" Text="Forgot Password" CssClass="MBUTTON"></asp:button></TD>
													</TR>
													<TR vAlign="top" bgColor="#fbfbfb">
													</TR>
												</TABLE>
