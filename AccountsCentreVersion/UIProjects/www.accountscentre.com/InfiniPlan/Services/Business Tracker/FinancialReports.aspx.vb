...
#End Region
    ...
    Public Sub MonthlyHeadingSettins()
        ...
        lblTime.Text = cmbMonth.SelectedValue
        Period = cmbMonth.SelectedIndex + 1
    ...
    Public Sub MonthlyBalanceSheet(ByVal IOPeriod As Integer, ByVal DateFrom As String)
        ...
        Try
            ...
            Try
                bsDV = objBS.BalanceSheet(GetConnectionData.CustomerID, fromDate, toDate)
            Catch ex As Exception
        ...
        Try
            ...
            Try
                ...
                Else
                    ...
                    If bit = True Then
                        bsDVForLastYears = objBS.BalanceSheet(GetConnectionData.CustomerID, fromDatePrevious, toDaterevious)
                    Else
                        bsDVForLastYears = Nothing
                    End If
                End If
    ...
    Private Sub addMonthds()
        ...
        If startingMonth > (Now.Month - 1) Then
            cmbMonth.Items.FindByText(strValueMonthArry(Now.Month - 1) & ", " & startingYear).Selected = True
        Else
            cmbMonth.Items.FindByText(strValueMonthArry(Now.Month - 1) & ", " & CurrentPlan.StartYear).Selected = True
        End If
    End Sub
    ...
    Private Sub cmbMonth_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbMonth.SelectedIndexChanged
        If _ReportID = 1 Then
            MonthlyIncomeStatement(cmbMonth.SelectedIndex + 1, cmbMonth.SelectedValue)
        ElseIf _ReportID = 3 Then
            MonthlyBalanceSheet(cmbMonth.SelectedIndex + 1, cmbMonth.SelectedValue)
        End If
    End Sub
    ...
    'Private Sub lnkBackMonth_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles lnkBackMonth.Click

    '    lnkNextMonth.Enabled = True
    '    lnkLast.Enabled = True
    '    lnkNextMonth.ImageUrl = "/images/InfiniPlan/lnkNextMonth.gif"
    '    lnkLast.ImageUrl = "/images/InfiniPlan/lnkLast.gif"
    '    movebackMonth()

    '    If (_loop = 1) Then
    '        lnkBackMonth.Enabled = False
    '        lnkFirst.Enabled = False
    '        lnkBackMonth.ImageUrl = "/images/InfiniPlan/s_lnkBackMonth.gif"
    '        lnkFirst.ImageUrl = "/images/InfiniPlan/s_lnkFirst.gif"
    '    End If
    '    moveBackYear(_loop, CType(Session("ID"), Integer))

    '    lblTime.Text = CType(month.Item(_loop - 1), String) + " " + CType(displayYear, String)
    '    Session("date") = _loop - 1
    '    If _ReportID = 1 Then
    '        MonthlyIncomeStatement(CType(Session("date"), Integer) + 1, lblTime.Text)
    '    ElseIf _ReportID = 3 Then
    '        MonthlyBalanceSheet(CType(Session("date"), Integer) + 1, lblTime.Text)
    '    End If
    'End Sub

    'Private Sub lnkNextMonth_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles lnkNextMonth.Click

    '    lnkBackMonth.Enabled = True
    '    lnkFirst.Enabled = True
    '    lnkBackMonth.ImageUrl = "/images/InfiniPlan/lnkBackMonth.gif"
    '    lnkFirst.ImageUrl = "/images/InfiniPlan/lnkFirst.gif"

    '    movenextMonth()

    '    If (_loop = 10) Then
    '        lnkNextMonth.Enabled = False
    '        lnkLast.Enabled = False
    '        lnkNextMonth.ImageUrl = "/images/InfiniPlan/s_lnkNextMonth.gif"
    '        lnkLast.ImageUrl = "/images/InfiniPlan/s_lnkLast.gif"

    '    End If

    '    moveNextYear(_loop, CType(Session("ID"), Integer))

    '    lblTime.Text = CType(month.Item(_loop + 1), String) + " " + CType(Session("Year"), String)
    '    Session("date") = _loop + 1
    '    If _ReportID = 1 Then
    '        MonthlyIncomeStatement(CType(Session("date"), Integer) + 1, lblTime.Text)
    '    ElseIf _ReportID = 3 Then
    ...
    'Private Sub lnkFirst_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles lnkFirst.Click
    ...
    '    lblTime.Text = CType(month.Item(0), String) + " " + CType(CurrentPlan.StartYear, String)
    '    Session("date") = 0
    '    If _ReportID = 1 Then
    '        MonthlyIncomeStatement(CType(Session("date"), Integer) + 1, lblTime.Text)
    '    ElseIf _ReportID = 3 Then
    ...
    'Private Sub lnkLast_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles lnkLast.Click

    '    Dim intYear As Integer
    '    If CType(month.Item(0), String) <> "Jan" Then
    '        intYear = CurrentPlan.StartYear + 1
    '    Else
    '        intYear = CurrentPlan.StartYear
    '    End If
    '    lblTime.Text = CType(month.Item(11), String) + " " + CType(intYear, String)
    '    lnkNextMonth.Enabled = False
    '    lnkLast.Enabled = False
    '    lnkNextMonth.ImageUrl = "/images/InfiniPlan/s_lnkNextMonth.gif"
    '    lnkLast.ImageUrl = "/images/InfiniPlan/s_lnkLast.gif"
    ...
    'Public Function moveNextYear(ByVal hashloop As Integer, ByVal currentMID As Integer) As Integer
    '    Dim MonthDif As Integer = (month.Count - 1) - currentMID
    '    If hashloop < MonthDif Then
    ...
    'Public Function moveBackYear(ByVal hashloop As Integer, ByVal currentMID As Integer) As String

    '    Dim MonthDif As Integer = (month.Count - 1)
    '    If hashloop - 1 > MonthDif - currentMID Then
    '        displayYear = CType(Session("Year"), Integer)
    '        Session("Year") = displayYear
    '    Else
    '        displayYear = CType(Session("Year"), Integer)
    '        displayYear = CurrentPlan.StartYear
    ...
    '        _loop = 0
    '    Else
    '        _loop = CType(Session("date"), Integer)
    '    End If
    'End Sub

    'Public Sub movebackMonth()
    '    _loop = CType(Session("date"), Integer)
    'End Sub
