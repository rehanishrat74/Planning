																...
																<tr>
																	<td valign="top" align=center>
																		...
																		<asp:Panel id="pnlChart" runat="server" Width="664px" Height="440px">
																			<P>
																				<asp:label id="lblSelect" runat="server" Width="35%" CssClass="lblGeneral" Height="20px"></asp:label>
																				<asp:dropdownlist id="cboCharts" runat="server" Width="327px" Height="86px" AutoPostBack="True">
