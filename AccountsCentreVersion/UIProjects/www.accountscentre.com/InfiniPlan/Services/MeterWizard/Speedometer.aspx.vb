...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    'Dim formatedDAte As String = CStr(Date.DaysInMonth(CInt(strGetDate(2)), CInt(strGetDate(1))))
        '    'BDPLite2.SelectedValue = formatedDAte + " " + cmbMonth.Items(11).Text
        '    lblfiscalyear.Text = "(Fiscal year:<b> " + cmbMonth.Items(0).Text + " </b> To <b>" + cmbMonth.Items(11).Text + "</b>)"
    ...
    Public Sub FUN_ALterMovie()
        ...
        Else
            Session("StartInterval") = Nothing
            Session("EndInterval") = Nothing
        End If
    ...
    Public Sub LoadMovie_Create()
        ...
        & "&AnalysisOption=" & Clipanalysisid + "&StartInterval=" & CType(Session("StartInterval"), String) + "&EndInterval=" & CType(Session("EndInterval"), String) + "&ChkInterval=" & s
    ...
    Public Sub Load_treeView(ByVal Meterid As String, ByVal A_id As String, ByVal MeterName As String)
        ...
        For outloopChk = 1 To trRowscount
            ...
            For inloopChk = countVal To maxCount
                ...
                '_column.Text = CType(dspopulateTeee.Tables(0).Rows(inloopChk).Item(1), String)
                If Clip = "rbIActuals.Checked" Then
                    _column.Text = movie + "<input type=radio name='myradiogroup' onclick='SetRbValue1(this.value,0)' value=" & CType(A_id, String) & ">" + MeterName
                Else
                    _column.Text = movie + "<input type=radio name='myradiogroup' onclick='SetRbValue1(this.value,1)' value=" & CType(A_id, String) & ">" + MeterName
                End If
    ...
    Public Sub Load_treeViewAdvance(ByVal Meterid As String, ByVal A_id As String, ByVal MeterName As String)
        ...
        devMeter = devMeter.Replace("height='220'", "height='200'")
