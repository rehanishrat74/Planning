																				...
																				<TABLE width="100%" align="center" border="0">
																								...
																								<TABLE align="center" border="0">
																									<TR>
																										...
																										<TD>
																											...
																											<asp:ImageButton id="btnAdvSearch" runat="server" ToolTip="Advance" ImageUrl="/images/InfiniPlan/AdvanceSearch.Gif"></asp:ImageButton></TD>
																										<TD></TD>
																										<TD>
																					...
																					<TR>
																						<TD width="100%"><!--Existing Plan Grid --><BR>
																							<BR>
																							<asp:datagrid id="ExistingPlanGrid" runat="server" Height="100%" PageSize="10" CellPadding="3"
																								AutoGenerateColumns="False" GridLines="Both" AllowPaging="True" width="100%">
																								...
																								<Columns>
																									...
																									<asp:BoundColumn DataField="BusinessDescription" ItemStyle-Font-Names="Verdana, Arial, Helvetica, sans-serif"
																									...
																									<asp:BoundColumn DataField="DateCreated" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10"
																										...
																										ItemStyle-Font-Size="8"></asp:BoundColumn>
																									<asp:TemplateColumn>
																				...
																				<TABLE width="100%" align="center" border="0">
																					...
																					<TR>
																						<TD class="TDPlanManager_Style" width="100%"><!-- SamplePlanGrid -->
																							<asp:datagrid id="SamplePlanGrid" runat="server" Height="100%" PageSize="10" CellPadding="3" AutoGenerateColumns="False"
																								GridLines="Vertical" AllowPaging="True" width="100%" cssclass="GridSamplePlans1">
																					...
																					<TR vAlign="top">
																						<TD align="center">
																							<asp:button id="BtnBack" onmouseover="this.className='MBUTTONACCPROON'; " onmouseout="this.className='MBUTTONACCPRO';"
																								runat="server" Width="10%" Text="Back" Cssclass="MBUTTONACCPRO" Font-Size="8pt"></asp:button></TD>
																					</TR>
																				</TABLE>
																			</asp:panel></TD>
																	</TR>
