...
#End Region
    ...
    Private Sub InitiliazeLanguage()
        ...
        'Me.lblHeading.Text = ResMgr.GetString("bizplanweb_services_preferences_planpreferences_lblHeading")
        Me.lblHeading.Text = ResMgr.GetString("bizplanweb_services_preferences_planpreferences_lblHeading1")
