						...
						<table cellSpacing="0" cellPadding="0" width="100%" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									...
									<table class="centretable" cellSpacing="0" cellPadding="0" width="100%" height="100%">
										<tr>
											<td vAlign="top" align="center">
												<P><SPAN></SPAN><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Tw Cen MT'; mso-fareast-font-family: SimSun; mso-bidi-font-family: 'Tw Cen MT'; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-weight: bold"><STRONG>
															<asp:label id="lblTableHeading" style="PADDING-RIGHT: 10px" runat="server" Cssclass="lblHeading"
																Width="100%"></asp:label></STRONG></SPAN></P>
											</td>
										</tr>
										<tr>
											<td vAlign="top" align="center">
												<table cellSpacing="0" cellPadding="0" width="100%" height="100%" dir="ltr">
													<tr>
														<td class="TableBox_Top_Left"><IMG src="\images\blank.gif" width="16"></td>
														<td class="TableBox_Top">&nbsp;</td>
														<td class="TableBox_Top_Right">&nbsp;</td>
													</tr>
													<TR>
													...
													<tr>
														...
														<td align="center" valign="top">
															<TABLE id="Table1" cellSpacing="0" height="100%" width=50%>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%" colSpan="1" rowSpan="1"><div Class="page-section-text"><asp:label id="lblPlanTitle" runat="server" Height="7px"></asp:label>
																		</div>
																	</TD>
																	<TD width="1%"></TD>
																...
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblDate" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><INPUT class="Covertxtfields" id="txtDate" type="text" name="txtDate" runat="server"></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%" colSpan="1" rowSpan="1"><div Class="page-section-text"><asp:label id="lblCopyNumber" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><INPUT class="Covertxtfields" id="txtCopyNo" type="text" name="txtCopyNo" runat="server"></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblOwner" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><INPUT class="Covertxtfields" id="txtOwnership" type="text" name="txtOwnership" runat="server"></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblName" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><TEXTAREA class="CovertxtArea" id="txtName" name="txtName" rows="2" cols="20" runat="server"></TEXTAREA></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblTitle" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><INPUT class="Covertxtfields" id="txtTitle" type="text" name="txtTitle" runat="server"></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblAddress" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																	<TD width="49.5%"><TEXTAREA class="CovertxtArea" id="txtAddress" name="txtAddress" rows="2" cols="20" runat="server"></TEXTAREA></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblPhone" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%" height="24"></TD>
																	<TD width="49.5%" height="24"><INPUT class="Covertxtfields" id="txtPhoneNo" type="text" name="txtPhoneNo" runat="server"></TD>
																</TR>
																<TR>
																	<TD vAlign="middle" align="left" width="30.5%"><div Class="page-section-text"><asp:label id="lblMisc" runat="server"></asp:label></div>
																	</TD>
																	<TD width="1%"></TD>
																...
																<TR>
																	<TD class="datagrid-data" vAlign="middle" align="left" width="30.5%" colSpan="1" rowSpan="2">
																		<P align="left">&nbsp;</P>
																	</TD>
																	<TD class="datagrid-data" width="1%">&nbsp;</TD>
																	<TD class="datagrid-data" width="49.5%">
																		<P align="left"><asp:button id="btnUpdateText" runat="server" Cssclass="MBUTTONACCPRO" onmouseover="this.className='MBUTTONACCPROON';"
																				onmouseout="this.className='MBUTTONACCPRO';" Width="96px"></asp:button></P>
																	</TD>
																</TR>
															</TABLE>
														</td>
