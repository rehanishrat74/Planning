...
Public Class IndexHeader
    ...
    Protected WithEvents lnkFHAutoLogin As System.Web.UI.WebControls.LinkButton
    ...
    Public ReadOnly Property CurrentUserScript()
        Get
            If Me.Page.User.Identity.IsAuthenticated Then
                Return "<script>var currentuser=" & Chr(34) & "Welcome Customer " & Session("UserUID") & Chr(34) & ";</script>"
            Else
                Return "<script>var currentuser='';</script>"
            End If
        End Get
    End Property
    'Events
    ...
    Private Sub lnkFHAutoLogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkFHAutoLogin.Click
        AutoLoginFormationsHouse()
    End Sub
End Class
