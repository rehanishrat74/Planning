		...
		<form id="msgform" method="post" runat="server">
			<table class="CONTENT" id="layouttable" height="100%" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD id="membersarea" vAlign="top" align="left" width="95%" runat="server">
            ...
            <TABLE id="" cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TR>
                <TD>
<asp:datagrid id=inboxGrid runat="server" Width="100%" BackColor="LightSteelBlue" OnItemDataBound="inboxGrid_ItemDataBound" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanged="inboxGrid_Page">
...
<asp:Button class=MBUTTON id=btnNew onmouseover="this.className='MBUTTONON';" runat="server" Width="93px" Height="18px" Text="New Message" BorderColor="#336699" BorderStyle="Solid" BorderWidth="1px"></asp:Button>&nbsp; 
<!--<INPUT class="MBUTTON" onmouseover="this.className='MBUTTONON';" style="WIDTH: 53px; HEIGHT: 19px" onclick="DeleteMessages()" onmouseout="this.className='MBUTTON';" type="button" value="Delete">
													<INPUT id="allcheck" onclick="checkAll(this);" type="checkbox" name="allcheck"--></TD></TR></TABLE>
									</asp:panel></TD>
							</TR>
							<tr>
...
<asp:Button class=MBUTTON id=btnReplyMessage onmouseover="this.className='MBUTTONON';" runat="server" Width="60px" Height="18px" Text="Reply" BorderColor="#336699" BorderStyle="Solid" BorderWidth="1px"></asp:Button>
<asp:Button class=MBUTTON id=btnNewMessage onmouseover="this.className='MBUTTONON';" runat="server" Width="93px" Height="18px" Text="New Message" BorderColor="#336699" BorderStyle="Solid" BorderWidth="1px"></asp:Button>
<asp:Button class=MBUTTON id=btnStatus onmouseover="this.className='MBUTTONON';" runat="server" Width="102px" Height="18px" Text="Complete Status" BorderColor="#336699" BorderStyle="Solid" BorderWidth="1px"></asp:Button></TD></TR></TABLE>
									</asp:panel></td>
							</tr>
							<tr>
								<td><br>
							...
							<TR>
								<TD align="center"><asp:panel id="pnlMessageReply" Runat="server" Width="98%">
            <TABLE id=tblReplyMessage cellSpacing=0 cellPadding=0 width="100%" 
            border=0>
              <TR>
                <TD style="HEIGHT: 1px" align=left><STRONG><FONT color=#336699 
                  size=2>Subject:</FONT></STRONG> 
<asp:textbox id=txtpsubject runat="server" Width="515px" CssClass="mtbox"></asp:textbox></TD></TR>
              <TR>
                <TD style="HEIGHT: 21px" align=left><STRONG><FONT 
                  color=#336699 size=2>Service:</FONT> 
<asp:dropdownlist id=Services runat="server" Width="271px" CssClass="mtbox">
              ...
              <TR>
                <TD align=right>
<asp:textbox id=txtpMessage runat="server" Width="100%" Height="223px" CssClass="mtbox" TextMode="MultiLine"></asp:textbox></TD></TR>
              <TR>
                <TD align=right width="100%">&nbsp;&nbsp; <INPUT class=MBUTTON onmouseover="this.className='MBUTTONON';" onclick=PostMessage(); onmouseout="this.className='MBUTTON';" type=button value=Post/Reply Width="81px"> 
                </TD></TR></TABLE>
									</asp:panel></TD>
							</TR>
							<TR>
								<TD align="center"><asp:panel id="pnlDisplayMessage" style="OVERFLOW: auto" Runat="server" Width="100%" Font-Size="XX-Small"
										Font-Names="ververdana" HorizontalAlign="Justify"></asp:panel></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
