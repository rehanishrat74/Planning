...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Payroll.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.ServicesPayroll" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
		<title>Accounts Centre - Online Services - Infini Payroll</title>
			...
			<table id="layouttable" height="100%" cellspacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr>
					<td id="contentarea" runat="server" width="95%"><br>
							...
							<TR>
								...
								<TD id="servicearea" runat="server" vAlign="top" align="left" width="80%">
									<TABLE class="content" id="Table6" style="WIDTH: 473px; HEIGHT: 253px" cellSpacing="0"
										...
										<TR>
											<TD class="acc_header_backgrounds" style="HEIGHT: 9px" colspan="3">&nbsp;Infini Payroll</TD>
										</TR>
										<TR>
											<TD style="WIDTH: 5px; HEIGHT: 125px" vAlign="top"></TD>
                        ...
                        style="mso-ansi-language: EN-US">InfiniPayroll software 
                        is your dependable payroll management tool, 
                        which:<?xml:namespace prefix = o 
/>
<o:p></o:p></SPAN></P>
                        <UL style="MARGIN-TOP: 0in" type=disc>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Provides free 
                          E-filing of Corporation Tax Return (CT600) with the 
                          Inland Revenue
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Maintains complete 
                          online records of all transactions with the Inland 
                          Revenue
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Offers live support 
                          for accounting services through phone and 
                          email
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Assists you in 
                          preparing and filing Company's annual accounts 
                          <o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Provides free review 
                          of the accounts that you maintain 
                          online
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Creates and maintains 
                          employee records
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Files start-of-year, 
                          in-year and end-of-year forms
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Records weekly and/or 
                          monthly salary and wage payouts
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Edits tax codes for 
                          applying on sales and purchases
<o:p></o:p></SPAN></LI>
                          <LI class=MsoNormal 
                          style="LINE-HEIGHT: 150%; TEXT-ALIGN: justify; mso-list: l0 level1 lfo1; tab-stops: list .5in"><SPAN 
                          style="mso-ansi-language: EN-US">Provides 
                          comprehensive view of your previous year’s 
                          records
<o:p></o:p></SPAN></LI></UL>
                        <P align=justify>&nbsp;</P>
														</TD>
										...
										<TR>
											<TD style="WIDTH: 5px; HEIGHT: 169px" vAlign="top"></TD>
											<TD style="HEIGHT: 169px" vAlign="top">
												<UL>
													<LI>
														<DIV align="justify">&nbsp;
														</DIV></LI>
