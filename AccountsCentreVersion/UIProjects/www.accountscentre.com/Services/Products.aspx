											...
											<TR>
												<TD bgColor="#cecfce">
													<TABLE class="CONTENT" width="100%" bgColor="#ffffff" border="0">
														...
														<TR>
															<TD>
																<asp:datagrid id="grdPackages" runat="server" Width="590px" CellPadding="3" BorderColor="#7BAEE3"
														...
														<TR>
															<TD>
																<asp:datagrid id="grdProducts" runat="server" Width="590px" CellPadding="3" BorderColor="#7BAEE3"
																	BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False">
																	<SelectedItemStyle Font-Size="XX-Small" Font-Bold="True"></SelectedItemStyle>
																	<ItemStyle Font-Size="XX-Small"></ItemStyle>
																	<Columns>
