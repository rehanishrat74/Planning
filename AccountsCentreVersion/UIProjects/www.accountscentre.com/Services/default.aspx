<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.ServicesDefault" %>
...
<HTML>
	<HEAD>
		<title>Accounts Centre - Online Services</title>
		<meta name="cbwords" content='Online Services,Services ,AccountsCentre Services'>
	...
	<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" runat="server" ID="Body1">
		<form id="Form1" method="post" runat="server">
			<table id="layouttable" height="100%" cellspacing="0" cellpadding="0" width="100%" border="0"
				...
				<tr>
					<td id="contentarea" runat="server" width="95%" style="HEIGHT: 120px"><br>
