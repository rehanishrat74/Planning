...
Public Class SecureData
    ...
    Protected Const cryptoKey As String = "poijwaefjkasfkjqwekg"
    Protected IV As Byte() = New Byte(7) {240, 45, 78, 0, 12, 36, 99, 122}
    Protected Const TimeStampKey As String = "lkjashdfkjhasdjfh"

    Protected _expireTime As DateTime = Now.MaxValue
...
#End Region
    ...
    Protected Function encrypt(ByRef strSerializedQueryString As String) As String
    ...
    Protected Function decrypt(ByRef strEncryptedQueryString As String) As String
        Try
    ...
    Protected Function deserialize(ByRef strDecryptedQueryString As String) As String
