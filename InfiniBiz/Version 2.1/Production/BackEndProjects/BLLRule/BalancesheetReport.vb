...
Public Class BalancesheetReport
    ...
    Public Shared Function GetBalanceSheetCurrentAmt1(ByVal CustomerID As Integer, ByVal _lowLID As String, ByVal _highLID As String, ByVal _dateFrom As Date, ByVal _dateTo As Date) As Double
    ...
    Public Shared Function GetBalanceSheetYTDAmt1(ByVal CustomerID As Integer, ByVal _lowLID As String, ByVal _highLID As String, ByVal _mydate As Date) As Double
