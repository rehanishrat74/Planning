...
#Region "Protected Methods"
    ...
    Protected Function AddNewRow(ByVal heading As String, ByVal Unit As String, ByVal showImage As Integer) As DataRow
        ...
        Dim strImageURL As String = "http://" & System.Web.HttpContext.Current.Request.Url.Host
        navCell.InnerHtml = "<width='1000'> <img src='" & strImageURL & "/images/InfiniPlan/link_icon.gif'   >"
