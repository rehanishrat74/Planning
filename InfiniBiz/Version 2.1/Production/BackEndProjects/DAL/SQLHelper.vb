...
#Region "................. Overridden Methods"
    ...
    Public Overrides Function ExecuteReader(ByVal connData As ConnectionData, ByRef objCommand As InfiniCommand) As IDataReader
        PrepareCommand(connData, objCommand)
        Dim dr As IDataReader = _command.ExecuteReader()
        Return dr
    End Function

    Public Overrides Function ExecuteDataset(ByVal connData As ConnectionData, ByRef objCommand As InfiniCommand) As DataSet
        Dim ds As New DataSet
        PrepareCommand(connData, objCommand)

        'create the DataAdapter & DataSet
        Dim da As SqlDataAdapter = New SqlDataAdapter(CType(_command, SqlCommand))
    ...
    Public Overrides Function ExecuteNonQuery(ByVal connData As ConnectionData, ByRef objCommand As InfiniCommand) As Integer
    ...
    Public Overrides Function ExecuteScalar(ByVal connData As ConnectionData, ByRef objCommand As InfiniCommand) As Object
...
#Region "...................Private Methods "
    ...
    Private Sub AttachParameters(ByVal objCommand As InfiniCommand)
        '_sqlParameters = New SqlParameter() '(objCommand.Count) {}
        Dim newSQLParameter As SqlParameter
        Dim infiniParam As InfiniParameter
        'Dim loopCount As Integer = 0
        For Each infiniParam In objCommand.Parameters
            newSQLParameter = New SqlParameter(infiniParam.Name, infiniParam.Value)
            'loopCount += 1
            _command.Parameters.Add(newSQLParameter)
        Next

    End Sub

    Private Sub PrepareCommand(ByRef connData As ConnectionData, ByRef objCommand As InfiniCommand)


        _connection = ConnectionFactory.GetConnection(connData)
        ...
        _command.CommandText = objCommand.CommandName
        ...
        If Not (objCommand.Parameters Is Nothing) Then
            AttachParameters(objCommand)
        End If
...
'    Public Overloads Shared Function ExecuteReader(ByVal commandType As CommandType, ByVal commandText As String) As SqlDataReader
...
'    ' Returns: A SqlDataReader containing the resultset generated by the command 
'    Public Overloads Shared Function ExecuteReader(ByVal commandType As CommandType, ByVal commandText As String, ByVal ParamArray commandParameters() As SqlParameter) As SqlDataReader
...
'            commandParameters = SqlHelperParameterCache.GetSpParameterSet(_strConnectionString, spName)
