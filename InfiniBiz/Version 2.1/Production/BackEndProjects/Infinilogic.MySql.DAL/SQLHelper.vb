...
'*********************************************************************
Public NotInheritable Class MySql_SqlHelper
...
#Region " Private methods & constructors"
    ...
    Public Shared Function EstablishConnection(Optional ByVal strConnectionString As String = "") As Boolean
        ...
        If strConnectionString = "" Then
            ...
            strConnectionString = MySql_Connection.GetConnectionString(True)
            'Else
            '   strConnectionString = strConnectionString
        End If
        Dim objConnection As New MySqlConnection(strConnectionString)
        objConnection.Open()
    ...
    Public Shared Function EstablishAdminConnection() As String
        ...
        Return MySql_Connection.GetConnectionString(True)


    End Function

    Public Shared Function OpenDataAdapter(ByVal SqlQuery As String, ByVal Conn As MySqlConnection) As MySqlDataAdapter
        Conn.Open()
        Dim sqlda As New MySqlDataAdapter(SqlQuery, Conn)
        Return sqlda
    End Function
    '*********AttachParameters *******************************************************
    '
    ...
    Private Shared Sub PrepareCommand(ByVal command As MySqlCommand, _
                                                            ByVal connection As MySqlConnection, _
                                                            ByVal transaction As MySqlTransaction, _
                                                            ByVal commandType As CommandType, _
                                                            ByVal commandText As String, _
                                                            ByVal commandParameters() As MySqlParameter)
    ...
    Protected Shared Function GetConnectionString(ByVal ConnectionDB As MySql_Connection.ConnectTo) As String
        Return MySql_Connection.GetConnectionString(ConnectionDB)
    End Function
...
#Region " ExecuteReader overloads"
    ...
    Public Overloads Shared Function ExecuteReader(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal commandType As CommandType, ByVal commandText As String) As MySqlDataReader
        ' Pass through the call providing null for the set of SqlParameters
        Return ExecuteReader(ConnectionDB, commandType, commandText, CType(Nothing, MySqlParameter()))
    ...
    ' Returns: A SqlDataReader containing the resultset generated by the command 
    Public Overloads Shared Function ExecuteReader(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal commandType As CommandType, ByVal commandText As String, ByVal ParamArray commandParameters() As MySqlParameter) As MySqlDataReader
        Dim cn As New MySqlConnection(GetConnectionString(ConnectionDB))
        '  Try
        cn.Open()
    ...
    Public Overloads Shared Function ExecuteReader(ByVal connection As MySqlConnection, _
        ...
        PrepareCommand(cmd, connection, CType(Nothing, MySqlTransaction), commandType, commandText, commandParameters)
    ...
    Public Overloads Shared Function ExecuteReader(ByVal strConnectionString As String, ByVal commandType As CommandType, ByVal commandText As String, ByVal ParamArray commandParameters() As MySqlParameter) As MySqlDataReader
        Dim cn As New MySqlConnection(strConnectionString)
        '  Try
        cn.Open()
        Return ExecuteReader(cn, commandType, commandText, commandParameters)
        'Finally
...
#Region " ExecuteNonQuery overloads"
    ...
    '
    '*********************************************************************
    Public Overloads Shared Function ExecuteNonQuery(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal commandType As CommandType, _
                                                     ByVal commandText As String, _
                                                     ByVal ParamArray commandParameters() As MySqlParameter) As Integer
        ...
        Catch e As MySqlException
            Throw New Exception(e.Message & e.Number, e)
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal spName As String, _
        ...
        If Not (parameterValues Is Nothing) And parameterValues.Length > 0 Then
            ...
            commandParameters = SqlHelperParameterCache.GetSpParameterSet(GetConnectionString(ConnectionDB), spName)

            'assign the provided values to these parameters based on parameter order
            AssignParameterValues(commandParameters, parameterValues)

            'call the overload that takes an array of SqlParameters
            Return ExecuteNonQuery(ConnectionDB, CommandType.StoredProcedure, spName, commandParameters)
            'otherwise we can just call the SP without params
        Else
            Return ExecuteNonQuery(ConnectionDB, CommandType.StoredProcedure, spName)
        End If
    End Function 'ExecuteNonQuery
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal connection As MySqlConnection, _
                                                    ByVal commandType As CommandType, _
                                                    ByVal commandText As String, _
                                                    ByVal ParamArray commandParameters() As MySqlParameter) As Integer
...
#Region " ExecuteDataset overloads"
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal commandType As CommandType, _
                                                    ByVal commandText As String, _
                                                    ByVal ParamArray commandParameters() As MySqlParameter) As DataSet
        'create & open a SqlConnection, and dispose of it after we are done.
        Dim cn As New MySqlConnection(GetConnectionString(ConnectionDB))
        Try
            cn.Open()
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal spName As String, _
        ...
        If Not (parameterValues Is Nothing) And parameterValues.Length > 0 Then
            ...
            'call the overload that takes an array of SqlParameters
            Return ExecuteDataset(ConnectionDB, CommandType.StoredProcedure, spName, commandParameters)
            'otherwise we can just call the SP without params
        Else
            Return ExecuteDataset(ConnectionDB, CommandType.StoredProcedure, spName)
        End If
    End Function 'ExecuteDataset
...
#Region " ExecuteScalar overloads"
    ...
    Public Overloads Shared Function ExecuteScalar(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal commandType As CommandType, _
                                                   ByVal commandText As String, _
    ...
    Public Overloads Shared Function ExecuteScalar(ByVal ConnectionDB As MySql_Connection.ConnectTo, ByVal spName As String, _
        ...
        If Not (parameterValues Is Nothing) And parameterValues.Length > 0 Then
            ...
            'call the overload that takes an array of SqlParameters
            Return ExecuteScalar(ConnectionDB, CommandType.StoredProcedure, spName, commandParameters)
            'otherwise we can just call the SP without params
        Else
            Return ExecuteScalar(ConnectionDB, CommandType.StoredProcedure, spName)
        End If
    End Function 'ExecuteScalar
...
#Region "Private methods"
    ...
    Private Shared Function DiscoverSpParameterSet(ByVal connectionString As String, _
        ...
        Dim cmd As MySqlCommand = New MySqlCommand(spName, cn)
