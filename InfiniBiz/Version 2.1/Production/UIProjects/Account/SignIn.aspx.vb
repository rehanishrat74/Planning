...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' RedirectTo(ACC_Redirection.SIGNIN)           ' REMOVING TEMPORARY

        If Session(ACC_ORDER_HERE_LINK) Is Nothing Then
        ...
        End If
        '*********(MNS)************
        SetFocus(txtCustomerID) 'txtuserid)
        '**************************
    ...
    Private Function SignIn()
        ...
        'Dim objCryptography As New Cryptography
        Dim objUser As New User
        SignInAccountsCentreUSer(txtCustomerID.Text, txtPassword.Text) 'txtuserid.Text, txtpassword.Text)
        'Dim blnMsg As Boolean
    ...
    'Private Sub btnSignin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    SignIn()
    'End Sub
    ...
    Private Sub btnSignUP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSignUP.Click
        Response.Redirect("https://www.accountscentre.com/Account/NewCustomer.aspx")
    End Sub
End Class
