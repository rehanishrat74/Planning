																...
																<TD width="100%" height="100%">
																	<DIV class="PlanExport" id="test" align="justify" width="100%">
																		<asp:panel id="Panel2" runat="server" Width="100%" height="100%" Visible="true">
																			<asp:datagrid id="dgExportedPlans" runat="server" Width="100%" cssclass="GridSamplePlans1" GridLines="Vertical"
																				...
																				<Columns>
																					<asp:TemplateColumn HeaderStyle-HorizontalAlign="Left"  ItemStyle-Font-Names="Verdana, Arial, Helvetica, sans-serif" ItemStyle-Font-Size=8>
