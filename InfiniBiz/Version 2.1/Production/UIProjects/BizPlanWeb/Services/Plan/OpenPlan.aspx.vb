    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If planID > "0" Then
                ...
                'Test 
                Dim NewId As String
                Dim newstrid() As String
                Dim Meterid As String
                NewId = Request.QueryString("pid")

                If NewId.IndexOf(",") > 0 Then
                    newstrid = NewId.Split(","c)
                    Meterid = newstrid(1)
                    Response.Redirect("/InfiniPlan/Services/Welcome.aspx?Meterid" + Meterid)
