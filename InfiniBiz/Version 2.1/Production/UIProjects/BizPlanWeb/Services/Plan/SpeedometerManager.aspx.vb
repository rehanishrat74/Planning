...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ds As DataSet = ObjCustomer.GetPlansListforMeters(GetConnectionData)
        BusinessStatus()
 ...
 & "</object> <br> <input type=radio name='myradiogroup' onclick='SetZoomValue(this.value,1)' value=" & CType("MTD", String) & ">  <u>" + "<b>This Month</b>" + " "
 ...
 & "</object><br> <input type=radio name='myradiogroup' onclick='SetZoomValue(this.value,1)' value=" & CType("YTD", String) & ">  <u>" + "<b>This Year</b>"
    ...
    Public Sub Load_treeView(ByVal ds As DataSet)
        ...
        For outloopChk = 1 To trRowscount
            ...
            For inloopChk = countVal To maxCount
                ...
                End If
                Dim x As String
                x = setMeterName(MeterName, planname)
