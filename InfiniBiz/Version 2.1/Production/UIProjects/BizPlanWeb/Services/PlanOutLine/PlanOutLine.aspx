		...
		<form id="Form2" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" align="center">
				<TBODY>
													...
													<td height="100%" valign="top">
														...
														<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<tr valign="top">
																<td><table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" align="center">
																		...
																		<TBODY>
																			<TR>
																				...
																				<!-- new -->
																				<td height="100%"><asp:panel id="TreeViewPanel" height="100%" Runat="server">
																							...
																							<TABLE id="TreeViewTable" align="center" valign="top">
																								...
																								<TR vAlign="top">
																									<TD align="left" width="100%" colSpan="2" height="183">
																										...
																										<DIV>
																											<iewc:treeview id="TreeView1" runat="server" Width="250px" Height="230px" AutoPostBack="True" HoverStyle="filter=none;background-color:#F3F3F3;"
																...
																<!-- new -->
																<td width="461" height="100%">
																 
																		<TABLE id="EditTable" height="293" align="center" valign="top">
																			<TR class="TRPlanOutLine_Style" vAlign="top" width="100%">
																				<TD width="100%" colSpan="2">
																					<asp:label id="lblEdit" runat="server" Width="100%" Height="16px" cssclass="PlanOutLine1"></asp:label></TD>
																			</TR>
																			<TR>
																			...
																			<TR>
																				<TD align="left" colSpan="2">
																					<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
																						<TR>
																							<TD width="434">
																								<asp:Label id="lblSelectedNodeTop" runat="server" CssClass="selectedNodeToplbl1"></asp:Label></TD>
																							<TD>
																									...
																									<TR>
																										<TD width="100%">
																											<asp:radiobutton id="rbRoot" onmouseover="showTooltip('ToolTip','rbRootTxt')" onmouseout="showTooltip('ToolTip','idleTxt')"
																												runat="server" Height="4px" cssclass="OutLineOptions" Checked="True" GroupName="rbChild" Text="Create folder"></asp:radiobutton>
																											<asp:radiobutton id="rbChild" onmouseover="showTooltip('ToolTip','rbChildTxt')" onmouseout="showTooltip('ToolTip','idleTxt')"
																												runat="server" Height="4px" cssclass="OutLineOptions" Text="Create subfolder"></asp:radiobutton></TD>
																										<TD align="right"></TD>
																									</TR>
																								</TABLE>
																							</TD>
																					...
																					<TABLE id="Table7" height="98" cellSpacing="0" cellPadding="0" width="317" align="center"
																						...
																						<TR>
																							<TD vAlign="top" align="center">
																								<DIV class="selectedNodelbl1" style="WIDTH: 298px" align="center">
																									<asp:Label id="lblSelectedNode" runat="server"></asp:Label></DIV>
																							</TD>
																						</TR>
																						<TR>
																							<TD class="PlanOutlineToolTip1" vAlign="top" align="left" colSpan="2" height="115">
					...
					<tr>
						<td class="TableBox_Bot_Left" width="0%">
						</td>
			...
			<tr id="trBottomMain" runat="server">
				<td vAlign="bottom" height="26" colspan="2"><uc1:bizplanfooter id="BizPlanFooter1" runat="server" DESIGNTIMEDRAGDROP="75"></uc1:bizplanfooter></td>
			</tr>
			</TBODY></TABLE>
		</form>
	</body>
