...
<HTML>
	...
	<body onload="checkStatus()" onunload="unloadWizard()" MS_POSITIONING="GridLayout">
		<form id="Form2" method="post" runat="server">
			<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center"  bgcolor="white">
				 
				<tr>
					<td height="19" vAlign="top" colSpan="2">
						<!--        Header Bar  -->
						<BUSINESSPLAN:HEADERBAR id="Headerbar2" runat="server"></BUSINESSPLAN:HEADERBAR><br>
				...
				<tr>
					...
					<asp:label id="lblHeader" runat="server" CssClass="lblHeading" Width="100%">Plan Wizard</asp:label>
						<table border="0" width="100%" height="96%" cellpadding="0" cellspacing="0" align="center" bgcolor="white">
							<tr>
								...
								<td align="center">
									<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" dir="ltr">
														...
														<TD vAlign="top"><INPUT id="hdnIsNew" type="hidden" runat="server" NAME="hdnIsNew"><INPUT id="hdnStatus" runat="server" type="hidden" NAME="hdnStatus">
															<DIV style="WIDTH: 592px; POSITION: relative; HEIGHT: 430px" ms_positioning="GridLayout">
																...
																<TABLE id="Table2" style="Z-INDEX: 112; LEFT: 16px; WIDTH: 560px; POSITION: absolute; TOP: 0px; HEIGHT: 104px"
																	...
																	<TR>
																		<TD class="wizardHeader1" vAlign="middle" align="center">
										...
										<tr>
											...
											<td class="TableBox_Bot_Right" width="0%">
											</td>
										</tr>
									</table>
								</td>
