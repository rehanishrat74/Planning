...
Public Class _PageBase
    ...
    'Provide Currency Sign persistence during session
    Protected ReadOnly Property CurrencyID() As String
        Get
            Dim CCID As String = Convert.ToString(Session("CustomerCurrencyID"))
            Return CCID
        End Get
    ...
    Sub Page_Error(ByVal Sender As Object, ByVal E As EventArgs) Handles MyBase.Error
        ...
        Try
            ...
            CommonBase.SendEmail(ConfigReader.GetItem(ConfigVariables.SMTPUserID), "errors@infinibiz.com", "Accountscentre Administration", body, Mail.MailFormat.Html)
