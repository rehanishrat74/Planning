...
<System.Web.Services.WebService(Namespace := "http://tempuri.org/FAQSystem/FAQSystem")> _
...
#End Region
    ...
    <WebMethod()> _
       Public Function HelloWorld1(ByVal Questionid As String, ByVal Par1 As String, ByVal Par2 As String, ByVal Par3 As String) As String
        Return "its service to create product "
    End Function
