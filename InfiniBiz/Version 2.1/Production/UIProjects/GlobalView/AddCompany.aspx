<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AddCompany.aspx.vb" Inherits="accounts.infinibiz.Web.AddCompany" %>
					...
					<td id="contentarea" style="WIDTH: 100%" width="100%" runat="server">
						<TABLE class="CONTENT" id="layouttable2" height="100%" cellSpacing="0" cellPadding="0"
							...
							<TBODY>
								...
								<tr>
									<TD id="menuarea" runat="server" vAlign="top" align="left" width="180">
									...
									<td align="center">
										<table cellSpacing="0" cellPadding="0">
											...
											<tr>
												<td style="BACKGROUND-COLOR: #34699e" colSpan="2" height="60"><font style="FONT-WEIGHT: bold; FONT-SIZE: 17pt" color="#ffffff">&nbsp;&nbsp;<asp:label id="lbladdcompany" runat="server" key="acc_globalview_addcompany_lbladdcompany"
															Width="186px"></asp:label></font>
													<br>
													<FONT style="FONT-SIZE: 8pt" color="#ffffff">&nbsp;&nbsp;&nbsp;<asp:label id="lblcompleteaccess" runat="server" key="acc_globalview_addcompany_lblcompleteaccess"></asp:label></FONT>
												</td>
											</tr>
											<tr>
												<td class="content" style="HEIGHT: 37px" vAlign="top" width="565" bgColor="#edf3f8"
													colSpan="2" height="30"><br>
													<font size="3"><SPAN class="content">&nbsp;&nbsp;<asp:label id="lbltoaddanother" runat="server" key="acc_globalview_addcompany_lbltoaddanother"></asp:label></SPAN>
													</font>
													<br>
													<br>
												</td>
											...
											<tr>
												<td class="content" vAlign="middle" width="90" bgColor="#fbfbfb"><font size="1">&nbsp;&nbsp;<STRONG><asp:label id="lbluserID" runat="server" key="acc_customerID" Width="160px"></asp:label><br>
														</STRONG>&nbsp;&nbsp;<STRONG><asp:label id="lblpassword" runat="server" key="acc_lblpassword" Width="168px"></asp:label></STRONG></font>
													<P></P>
													<p align="left">&nbsp;</p>
												</td>
												<td vAlign="middle" noWrap align="left" width="314" bgColor="#fbfbfb">
													...
													<font color="#000080">
														<asp:button id="btnUpdate" onmouseover="this.className='MBUTTONON';" style="FONT-WEIGHT: bold"
															...
															value="Update" key="acc_globalview_addcompany_btnupdateglobalview"></asp:button>
														<asp:button id="btnCancel" onmouseover="this.className='MBUTTONON';" style="FONT-WEIGHT: bold"
															onmouseout="this.className='MBUTTON';" name="btnUpdate" cssclass="MBUTTON" Text="Cancel"
															key="acc_btncancel" Runat="server"></asp:button></font>
													<p></p>
												</td>
											</tr>
										</table>
