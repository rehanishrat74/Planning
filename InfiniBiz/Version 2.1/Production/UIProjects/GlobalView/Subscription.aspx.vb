...
#Region "Declarations"
    ...
    Protected WithEvents TheMessage As System.Web.UI.WebControls.Label

    Protected DGLast3Months_lblmonthexpired As String
    Protected DGExpired_lblexpired As String
...
#Region "Events"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        DGLast3Months_lblmonthexpired = load_culturevalue("acc_globalview_subscription_lblmonthsexpire") 'Services with Subscription being expired within 3 months
        DGExpired_lblexpired = load_culturevalue("acc_globalview_subscription_lblexpired") 'Services with Subscription already expired
...
#Region "Procedures"
    ...
    Private Sub RenderCustomerSubscriptionData(Optional ByVal bRecordsFilterChanged As Boolean = False)
        ...
        With ObjSubscriptionStatus
            ...
            If DtCustomerSubscription.Rows.Count = 0 And DtCustomerSubscription.Rows.Count = 0 Then
                ...
                TheMessage.Text = load_culturevalue("acc_globalview_subscription_lblmsgexpire") '"Dear Customer, currently you have no such services that are expired or about to expired."
            End If
    ...
    Private Sub Renew()
        ' modified by Yousuf
        'Session(Me.ACC_ORDER_HERE_LINK) = "Acc_Order_Here_Link" 'This will remove previous selected product
        Session("renewAll") = "true"
        'modification end
