...
<table id="Table1" cellspacing="0" cellpadding="0" width="100" border="0">
	<tr align="right" class="TableBody">
		...
		<td align="right">
			<asp:LinkButton id="btnShowListing" CssClass="ControlText" runat="server" Visible="False">Show List</asp:LinkButton>
			<asp:LinkButton id="Linkbutton1" CssClass="ControlText" runat="server" Visible="True"></asp:LinkButton>
		</td>
	</tr>
</table>
