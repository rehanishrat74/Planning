														...
														<tr>
															...
															<td height="100%" valign="top" align="center">
																...
																<asp:Panel id="pnlChart" runat="server" Width="664px" Height="440px" HorizontalAlign="Center">
																	<asp:label id="lblHeading" runat="server" Font-Size="Medium" Font-Underline="True" Font-Bold="True"
																		Font-Names="tahoma"></asp:label>
																	<BR>
																	<BR>
																	<asp:TextBox id="txtHoldValues" runat="server" width="0px" BorderStyle="None"></asp:TextBox>
																	<asp:label id="lblChartPeriods" runat="server" Font-Size="X-Small" Font-Bold="True" Font-Names="tahoma"></asp:label>
																	<BR>
																	<BR>
																	<TABLE width="60%">
																		<TR width="100%">
																			...
																			<TD width="60%">
																				<asp:DropDownList id="cmbPlanProducts" runat="server" CssClass="wizardoptions" width="100%" AutoPostBack="true"
																					onchange="changeText();"></asp:DropDownList></TD>
																		</TR>
																	</TABLE>
																	<P>
                        ...
                        src="DisplayCharts.aspx?fname=<%=cchartFileName%>">
																	...
																	<CENTER><BR>
																		<asp:button id="btnBack" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																			Runat="server" Cssclass="MBUTTONACCPRO"></asp:button></CENTER>
																</asp:Panel>
																<!-- dsads -->
															</td>
