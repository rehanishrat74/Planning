...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CustomerPoint.aspx.vb" Inherits="Infinilogic.BusinessPlan.Web.CustomerPoint"%>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
...
<HTML xmlns:o xmlns:u1>
 ...
 //SetDate();
	...
	window.frames.item(1).location= PageName +'?VisitProductSession='+Sessionid
	...
	window.frames.item(1).location= PageName +'?VisitOrdersSession='+Sessionid

	}
	
	function ProductDetail(ProductVisited,PageName)
	
	{
 
	window.frames.item(1).location= PageName +'?ProductSession='+ProductVisited

	}
	
	function OrdersDetail(ProductVisited,PageName)
	{
 
	window.frames.item(1).location= PageName +'?OrderSession='+ProductVisited

	}
		function OrderbyProductId(ProductVisited,PageName)
	{
 
	window.frames.item(1).location= PageName +'?OrderbyProductId='+ProductVisited
																...
																<TABLE height="100%" width="100%">
																	<TR>
																		<TD vAlign="top" align="center">
																			<asp:Label id="lblTime" runat="server" CssClass=wizardtext></asp:Label></TD>
																	</TR>
																	<TR height="50%">
																		<TD vAlign="top" align="center"><IFRAME id="ParentFrame" align="center" frameBorder="0" width="100%" scrolling="yes" height="100%"
																	...
																	<TR height="50%">
																		<TD><IFRAME id="ChildFrame" align="center" frameBorder="0" width="100%" scrolling="yes" height="100%"
																				runat="server"></IFRAME></TD>
																	</TR>
																	<TR>
																		<TD>
