...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Products.aspx.vb" Inherits="InfiniLogic.BusinessPlan.Web.Products"%>
<HTML>
	<HEAD>
		...
		window.parent.ProductDetail(ProductVisited,PageName);
		}
	 	
	  function OrderbyProductId(ProductVisited,PageName)
		{
	 
		window.parent.OrderbyProductId(ProductVisited,PageName);
		}
																...
																<asp:Table id="historytable" width="100%" Runat="server" EnableViewState="True" Border="0">
																	<asp:TableRow EnableViewState="True">
																		<asp:TableCell ID="GridCell" EnableViewState="True">
																			<asp:datagrid id="dgProduct" Width="100%" Runat="server" CssClass="wizardtext" EnableViewState="True"
																			...
																			<asp:datagrid id="dgProductChildGrid" Width="100%" Runat="server" CssClass="wizardtext" EnableViewState="True"
