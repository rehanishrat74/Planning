	...
	<HEAD>
 	 ...
 	 var getfocusid=document.getElementById("flashpanel");
 	 	...
 	 	function delete_prompt( )
		    ...
		    { 
		       alert('true')
		    window.open("Speedometer.aspx?AnalysisID=1&Deleteid=" & o) ;
		    }
		    else 
		    {
		    alert('false')
				...
				<TBODY>
					<tr>
						<td vAlign="top" height="19">
							...
							<input id="SelectedRowNumber" type="hidden" name="SelectedRowNumber"> <INPUT id="MeterName" type="hidden" name="MeterName">
												...
												<TBODY>
													...
													<tr>
														<td align="center"><asp:panel id="testpanel" height="100%" width="100%" Runat="server">
																								...
																								<TABLE height="10%" width="100%" border="0">
																									<TR vAlign="middle">
																										<TD vAlign="middle" align="center" width="100%" height="80%">
																											<ASP:LABEL id="lblNoProducts" runat="server" Font-Size="8" Font-Names="Verdana"></ASP:LABEL></TD>
																									</TR>
																								</TABLE>
																							</ASP:PANEL>
																																		...
																																		<TR>
																																			<TD align="center">
																																				<TABLE id="TABLE3" width="100%" align="center" border="0">
																																					<TR vAlign="bottom">
																																						<TD align="center"><IMG id="titleimg" height="207" src="/images/infiniplan/ImgTitleBasic.jpg" runat="server"
																																								Visible="False"></TD>
																																					</TR>
																																					<TR>
																																						<TD>
																																						...
																																						<TD>
																																							<ASP:BUTTON id="btnSearch" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																																								runat="server" Visible="False" Text="Search" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></TD>
																																					</TR>
																																				</TABLE>
																																				<asp:Label id="lblInfinidoc" runat="server" CssClass="wizardtext" Visible="false">All products has been selected for infiniboc </asp:Label></TD>
																																		</TR>
																																		<TR vAlign="top">
																																			<TD vAlign="top" align="center" width="40%" height="5%">
																																					...
																																					<TABLE width="100%" align="center" border="0">
																																						<TR>
																																							<TD align="center" bgColor="#f3f3f3" height="35">
																																								<asp:Panel id="Panel4" runat="server" CssClass="tableborder" Width="100%" Visible="True">
																																									<TABLE width="100%" align="center" border="0">
																																										<TR>
																																											<TD align="left">
																																												<asp:RadioButtonList id="rbProductOption" runat="server" CssClass="wizardtext" RepeatDirection="Horizontal">
																																													<asp:ListItem Value="1">All Products</asp:ListItem>
																																													<asp:ListItem Value="2" Selected="True">Single Product </asp:ListItem>
																																												</asp:RadioButtonList></TD>
																																											<TD>
																																												<asp:CheckBox id="chkCurrency" runat="server" CssClass="wizardoptions" AutoPostBack="True" Text="Show Currency"></asp:CheckBox></TD>
																																										</TR>
																																									</TABLE>
																																								</asp:Panel></TD>
																																						</TR>
																																						<TR>
																																							<TD vAlign="top" align="left">
																																								<TABLE height="1%" width="100%" align="center" border="0">
																																									<TR vAlign="top">
																																										<TD class="wizardtext" vAlign="top" align="center"><BR>
																																											From&nbsp;
																																						...
																																						<TR>
																																							<TD align="center" colSpan="5" height="1">
																																								<asp:CheckBox id="chkMTD" runat="server" CssClass="wizardtext" Width="155px" AutoPostBack="True"
																																				...
																																				<asp:Panel id="PanelLastYEars" runat="server" Width="100%" Visible="False">
																																					<TABLE width="100%" align="center" border="0">
																																						<TR>
																																							<TD align="left" colSpan="5" height="1">&nbsp;&nbsp;&nbsp;&nbsp;
																																								<asp:CheckBox id="chkboxPreviousYear" runat="server" CssClass="wizardtext" Width="1%" AutoPostBack="True"></asp:CheckBox>
																																								<asp:Label id="lblComparision" runat="server" CssClass="wizardtext">  Compare Intervels (Ledgers) </asp:Label><BR>
																																							</TD>
																																						</TR>
																																						<TR>
																																				...
																																				<P>
																																					<asp:Label id="lblScope" runat="server" CssClass="wizardOptions" Visible="False" Font-Size="8pt">Scope : </asp:Label>
																																					<asp:DropDownList id="ddlScope" runat="server" CssClass="wizardOptions" Visible="False" AutoPostBack="True">
																																						<asp:ListItem Value="Local">Local</asp:ListItem>
																																						<asp:ListItem Value="Global">Global</asp:ListItem>
																																					</asp:DropDownList>&nbsp;&nbsp;
																																					<asp:Label id="lblService" runat="server" CssClass="wizardOptions" Visible="False" Font-Size="8">Service :</asp:Label>
																																					<asp:DropDownList id="ddlService" runat="server" CssClass="wizardOptions" Visible="False">
																																						<asp:ListItem Value="Enterprise" Selected="False"></asp:ListItem>
																																						<asp:ListItem Value="InfiniOffice" Selected="False"></asp:ListItem>
																																					</asp:DropDownList></P>
																	...
																	<TR height="5%">
																		<TD align="right">
																			<ASP:BUTTON id="btnCancel" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																				runat="server" Text="Cancel" Cssclass="MBUTTONACCPRO" CausesValidation="False"></ASP:BUTTON></TD>
																		<TD align="right">
																			<ASP:BUTTON id="btnBack" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																				runat="server" Text="Back" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></TD>
																		<TD>
																			<ASP:BUTTON id="btnNext" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																				runat="server" Text="Next" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></TD>
																		<TD>
																			<ASP:BUTTON id="btnShow" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																				runat="server" Text="Save" Cssclass="MBUTTONACCPRO" Enabled="False"></ASP:BUTTON></TD>
																	</TR>
																</TABLE>
															</asp:panel></ASP:PANEL> 
															<!-- /Compose -->
															<!-- Compare --><asp:panel id="PanelCompare" width="100%" Runat="server" visible="false">
															...
															<!-- /Compare -- > 
															<!-- Listing --><asp:panel id="Panelnoclip" width="100%" Runat="server" visible="false">
																<TABLE height="100%" width="100%" align="center" border="0">
																	<TR vAlign="top" height="100%">
																		<TD vAlign="top" align="center">
																	...
																	<TR vAlign="top" width="100%">
																		<TD align="center" width="100%" height="97%">
																			<TABLE height="100%" width="100%" align="center" border="0">
																				<TR vAlign="top">
																					<TD align="center">
																						<ASP:PANEL id="PanelListingforClips" CssClass="tableborder1" Width="100%" Runat="server" visible="True">
																							<TABLE height="100%" width="100%" align="center" border="0">
																								<TR vAlign="top" >
																									<TD align="center"  >
																													...
																													<TD>
																														<DIV class="meterSpave1" id="divViews" align="center">
																															...
																															<ASP:BUTTON id="imgbtnBack" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																																runat="server" Visible="False" Text="Back" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></DIV>
																													</TD>
																												</TR>
																											</TABLE>
																										</ASP:PANEL></TD>
																									<TD vAlign="top" align="center"   rowSpan="2">
																										...
																										<ASP:PANEL id="PanelZoom" CssClass="tableborder1" Width="100%" Visible=False    Runat="server"
																											Height="95%" HorizontalAlign="Center" DESIGNTIMEDRAGDROP="1127">
																											<TABLE height="100%" width="100%" align="center" border="0">
																									...
																									<TD align="center">
																										<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="190" border="1">
																										 <TR>
																				...
																				<TABLE height="100%" width="100%" align="center" border="0">
																					<TR vAlign="top">
																						<TD width="100%" height="100%">
																							<ASP:PANEL id="PanelFav" CssClass="tableborder1" Width="100%" Runat="server" visible="True">
																								<TABLE height="100%" width="100%" align="center" border="0">
																									<TBODY>
																										<TR vAlign="top">
							...
							<!-- Compare Products --><asp:panel id="PanelCompareProducts" runat="server" Visible="False">
								<TABLE id="Table3" height="1%" width="100%" border="0">
									<TBODY>
										...
										<TR height="1%" width="50%">
											<TD align="center" colSpan="2"><asp:panel id="Panel2" runat="server" Width="50%" CssClass="tableborder1" Height="32px">
										...
										<TR vAlign="top" height="1%" width="50%">
											<TD vAlign="top" align="center" width="30%" height="1%"><ASP:PANEL class="comparetableborder" id="mypanel" Runat="server">
												...
												<ASP:BUTTON id="btnShowComparision" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
													runat="server" Visible="True" Text="Show" Cssclass="MBUTTONACCPRO" Enabled="False"></ASP:BUTTON>&nbsp;<asp:button id="btnNext_Compare" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
													runat="server" Text="Next" Cssclass="MBUTTONACCPRO"></asp:button></TD>
											<TD vAlign="top" align="center" width="30%" height="100%">
												<TABLE id="Table5" height="100%" align="center" border="0">
													<TR vAlign="top" align="centre">
														<TD align="center">
															<DIV class="meterSpaveCompare" id="maindiv"><asp:label id="lblCMeterName" runat="server" CssClass="flashTitle"></asp:label><ASP:TABLE id="PlanCompareTable" Visible="True" width="100%" Runat="server" Height="60%" border="0"
