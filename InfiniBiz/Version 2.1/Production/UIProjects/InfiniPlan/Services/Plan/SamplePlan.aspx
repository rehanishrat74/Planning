<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SamplePlan.aspx.vb" Inherits="Infinilogic.BusinessPlan.Web.SamplePlan"%>
						...
						<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									...
									<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td vAlign="top" align="center" width="97%" bgColor="#f3f3f3" height="19"><asp:label id="lblHeading" runat="server" CssClass="lblHeading" Width="97%">Sample Plan</asp:label></td>
										</tr>
										<tr>
											<td align="center"><asp:panel id="testpanel" Runat="server" width="100%" height="100%">
													<TABLE dir="ltr" height="99%" cellSpacing="0" cellPadding="0" width="100%" border="0">
														...
														<TR>
															...
															<TD vAlign="top">
																<asp:panel id="pnlSamplePlans" runat="server" Width="100%" CssClass="TDPlanManager_Style" Visible="False">
																	<TABLE height="100%" width="100%" align="center" border="0">
																				...
																				<TABLE class="GridBody" height="100%" width="100%" bgColor="#f3f3f3" border="0">
																					...
																					<TR vAlign="middle">
																						<TD vAlign="middle" align="left" colSpan="5">
																							<asp:label id="lblSmaplePlans" Runat="server" CssClass="wizardText"></asp:label><BR>
																						</TD>
																					</TR>
																				</TABLE>
																			</TD>
																		...
																		<TR height="75%">
																			<TD class="TDPlanManager_Style" width="100%"><!-- SamplePlanGrid -->
																				<asp:panel id="Panel1" runat="server" Width="100%" Visible="True" Height="275">
																					<asp:datagrid class="GridBody" id="SamplePlanGrid" runat="server" width="100%" PageSize="10" CellPadding="3"
																		...
																		<TR height="15%">
																			<TD align="center"><BR>
																				<asp:button id="BtnBack" onmouseover="this.className='MBUTTONACCPROON'; " onmouseout="this.className='MBUTTONACCPRO';"
																					runat="server" Width="10%" Visible="False" Text="Back" Cssclass="MBUTTONACCPRO" Font-Size="8pt"></asp:button></TD>
																		</TR>
																	</TABLE>
																</asp:panel></TD>
