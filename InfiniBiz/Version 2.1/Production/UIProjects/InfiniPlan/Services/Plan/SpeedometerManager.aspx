																								...
																								<TABLE height="100%" width="100%" align="center" border="0">
																									<TR vAlign="top">
																										...
																										<TD vAlign="top" align="center"  rowSpan="2">
																											...
																											<ASP:PANEL id="PanelZoom" CssClass="tableborder1" Width="100%" Runat="server"  
																												Visible=False  HorizontalAlign="Center" DESIGNTIMEDRAGDROP="1127">
																												<TABLE   width="100%" align="center" border="0">
																													<TR vAlign="top"  >
																														<TD align="center" width="100%">
																															<ASP:LABEL id="lblZoomEntitName" runat="server" cssclass="flashTitle">+</ASP:LABEL>
																															<DIV class="EnterpriseZoomSpace" id="divViews1" align="center">
