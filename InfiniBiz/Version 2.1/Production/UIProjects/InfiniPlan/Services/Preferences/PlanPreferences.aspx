																...
																<TABLE height="100%" width="100%"> <!--  row -->
																	...
																	<TR vAlign="top">
																		<TD align="center" height="5%"  >
																			<TABLE class="GridBody" id="tblExported" width="98%" runat="server" border=0>
																					<tr><td>&nbsp;</td></tr>
																				<TR class="alternatingRowItem" vAlign="top"   >
																					<TD vAlign="middle" align="center" width="225">
																						<asp:label id="lblPlanPref" runat="server" Font-Bold="True" cssclass="lblPlanPreferences_Style"></asp:label></TD>
																					...
																					<TD vAlign="middle" align="center" width="30%">
																						<asp:label id="lblDateExported" runat="server" Width="168px" Font-Bold="True" cssclass="lblPlanPreferences_Style'"></asp:label></TD>
																				</TR>
																						<tr><td>&nbsp;</td></tr>
																			</TABLE>
																		</TD>
																	...
																	<TR vAlign="top">
																		<TD vAlign="top" align="center">
																			<TABLE class="GridBody" width="98%" height = 100% border="0">
																			<tr><td>&nbsp;</td></tr>
																				<TR class="alternatingRowItem" vAlign="top">
																					<TD width="300">
																				...
																				<TD class="wizardtext" align=center>( Do you want to add <b>Tables</b> in plan to export ? ) </TD>
																				</TR>
																					<tr><td>&nbsp;</td></tr>
																				<TR class="alternatingRowItem">
																					...
																					<TD class="wizardtext" align=center>( Do you want to add <b>Charts</b> in plan to export ? ) </TD>
																				</TR>
																					<tr><td>&nbsp;</td></tr>
																				<TR class="alternatingRowItem">
																					<TD colSpan="4">
