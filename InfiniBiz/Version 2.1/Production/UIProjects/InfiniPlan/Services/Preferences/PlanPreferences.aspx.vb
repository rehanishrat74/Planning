...
#End Region
    ...
    Private Sub ShowExportedPlan()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            Me.lblErrorMessage.Text = "You plan has Exported.You can again export plan by clicking 'Export Plan' button."
        ...
        Else
            ...
            lblErrorMessage.Visible = True
            lblErrorMessage.ForeColor = Color.Black
            Me.lblErrorMessage.Text = "You can export your plan by clicking 'Export Plan' button."
