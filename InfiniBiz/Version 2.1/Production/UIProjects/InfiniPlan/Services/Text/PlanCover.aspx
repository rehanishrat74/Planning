												...
												<table cellSpacing="0" cellPadding="0" width="100%" border="0" height="100%" dir="ltr">
													...
													<tr valign="top">
														...
														<td align="center" valign="top">
															<TABLE id="Table1" border="0" class="GridBody" cellSpacing="0" width="80%" height="100%">
																<TR>
																	<TD width="15%">&nbsp;</TD>
																...
																<TR>
																	...
																	<TD width="49.5%" height="40"><BDP:BDPLITE id="txtDate" runat="server" enable="false" TextBoxColumns="23" Font-Names="Arial"
																			Font-Bold="True"></BDP:BDPLITE></TD>
																</TR>
																<TR>
																	<TD width="15%">&nbsp;</TD>
