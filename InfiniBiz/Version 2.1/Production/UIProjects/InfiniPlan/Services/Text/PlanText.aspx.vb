...
#Region "......................Event Handlers "
            ...
            If (Not IsNothing(Request.QueryString("hid"))) Then
                ...
                If Not (Page.IsPostBack) Then
                    If (Not headingID.Length = 0) Then
                        ...
                        If (drArr.Length > 0 And headingID.IndexOf("S") < 0) Then
                        ...
                        Else
                            ...
                            tblcontents.Visible = False
                            lblErrorMessage.Text = "You cant enter text under that heading.Restore that from HeadingOutLine option."
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If writtenHTML = "" Then
            lblErrorMessage.Text = "No Record to update."
        Else
