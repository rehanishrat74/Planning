<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AboutUs.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.AboutUs" %>
...
<HTML xmlns:o xmlns:st1>
	<HEAD>
		<title>Accounts Centre - Info Desk - About Us</title>
		<meta name="cbwords" content='Management Solutions,About AccountsCentre,Workforce Management,Specific Features,Main Features'>
				...
				<tr>
					<td id="contentarea" runat="server" width="95%">
						<TABLE class="content" id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
							border="0">
							<TR>
								<TD id="menuarea" runat="server" vAlign="top" align="left" style="WIDTH: 5px"><include:leftbar id="idxLeftBar" runat="server"></include:leftbar></TD>
								<TD id="membersarea" runat="server" vAlign="top" align="left" class="content">
									<P class="MsoNormal" style="TEXT-ALIGN: center; mso-layout-grid-align: none" align="center"><SPAN lang="EN-GB" style="FONT-FAMILY: Verdana; mso-ansi-language: EN-GB">
											<asp:Label ID="lblpagetext" Runat="server" key="acc_infodesk_aboutus_lblpagetext"></asp:Label>
										</SPAN>
									</P>
								</TD>
							</TR>
					...
					<td id="rightbar" width="5%" runat="server" vAlign="top" align="left"></td>
				</tr>
				<tr>
