...
#Region "<<< <<< <<< <<< <<< Web Form Designer Generated Code >>> >>> >>> >>> >>>"
    ...
    Protected WithEvents lblordernum2 As System.Web.UI.WebControls.Label
    Protected WithEvents Td10 As System.Web.UI.HtmlControls.HtmlTableCell
    Protected WithEvents ID1 As System.Web.UI.HtmlControls.HtmlAnchor
...
#Region "<<< <<< <<< <<< <<< Helper functions/Procedure >>> >>> >>> >>> >>>"
    ...
    Private Sub SetOrderDetails()
        ...
        Dim ds As DataSet
        Try
            ds = objCXLOrder.GetReSellerOrderDetails(CustomerID)
            dgrdOrderDetails.DataSource = ds
    ...
    Private Sub SetOrderInfo(ByVal OrderID As Integer)
        ...
        Dim ds As DataSet
        Try
            ds = objCXLOrder.GetReSellerOrderDetails(CustomerID, OrderID)
            dgrdOrder.DataSource = ds
            dgrdOrder.DataBind()
