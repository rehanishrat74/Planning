<%@ Control Language="vb" AutoEventWireup="false" Codebehind="DateCtrl.ascx.vb" Inherits="accounts.infinibiz.Web.DateCtrl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
