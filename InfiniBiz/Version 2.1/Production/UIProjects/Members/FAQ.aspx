...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FAQ.aspx.vb" Inherits="accounts.infinibiz.Web.FAQ" %>
...
<HTML>
	<HEAD>
		...
		<script>
var httpSiteName = "http://services.infinibiz.com";
...
function ShowTr(id)
{
	...
	<body id="Body1" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" runat="server">
		<form id="pform" action="" method="post" runat="server">
					...
					<tr>
						<td id="contentarea" width="100%" runat="server">
							<div class="scrolldiv"  style="height:100%">
								<TABLE class="content" id="Table1" width="100%" height="100%" cellSpacing="3" cellPadding="3"
									width="100%" border="0">
									<TBODY>
										<TR>
											<TD id="menuares" vAlign="top" align="left" width="5%" runat="server" CLASS='objtd'>
												<uc1:ServicesList id="ServicesList1" runat="server"></uc1:ServicesList></TD>
											<TD id="membersarea" vAlign="top" align="centre" width="80%" runat="server" CLASS='objtd'>
			...
			<td id="rightbar" width="29" runat="server"></td>
			</TR>
			<tr>
