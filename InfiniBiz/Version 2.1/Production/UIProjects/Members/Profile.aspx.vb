...
#Region "Declaration"
    ...
    Protected WithEvents CompState As System.Web.UI.WebControls.TextBox
    Protected WithEvents dtIntendedFinYear As System.Web.UI.WebControls.TextBox 'accounts.infinibiz.Web.datecontrol
    ...
    Protected WithEvents lblCompletename As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lblcompanyregistrationnumber As System.Web.UI.WebControls.Label
    Protected WithEvents lbltaxreferenceID As System.Web.UI.WebControls.Label
    Protected WithEvents lbldirectors As System.Web.UI.WebControls.Label
    Protected WithEvents lblsecretary As System.Web.UI.WebControls.Label
    Protected WithEvents lblotherinformation As System.Web.UI.WebControls.Label
    Protected WithEvents lblregisteredaddress As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lblcontactnumber As System.Web.UI.WebControls.Label
    Protected WithEvents lbllineofbusiness As System.Web.UI.WebControls.Label
    Protected WithEvents lbldescriptionofbusiness As System.Web.UI.WebControls.Label
    Protected WithEvents lblnumberofemployee As System.Web.UI.WebControls.Label
    Protected WithEvents lblworkdays As System.Web.UI.WebControls.Label
    Protected WithEvents lblfinancialyear As System.Web.UI.WebControls.Label
    Protected WithEvents lblvatnumber As System.Web.UI.WebControls.Label
    Protected WithEvents lblcompanylogo As System.Web.UI.WebControls.Label
    Protected WithEvents lblpayereferencenumber As System.Web.UI.WebControls.Label
    Protected WithEvents lblpayeofficenumber As System.Web.UI.WebControls.Label
    Protected WithEvents lblacc_payenumber As System.Web.UI.WebControls.Label
    Protected WithEvents lblnationalinsurance As System.Web.UI.WebControls.Label
    Protected WithEvents lblacc_offreference As System.Web.UI.WebControls.Label
    Protected WithEvents Td1 As System.Web.UI.HtmlControls.HtmlTableCell
    Protected WithEvents Td2 As System.Web.UI.HtmlControls.HtmlTableCell

    Protected WithEvents lblCurrency As System.Web.UI.WebControls.Label
    Protected WithEvents compCurrency As System.Web.UI.WebControls.DropDownList
    Protected WithEvents txtECON As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Sub ShowProfile()
        ...
        For Each t In pnlCompanyProfile.Controls
            ...
            ElseIf TypeOf t Is DropDownList Then
                ...
                If Not IsDBNull(oReader("CurrencyID")) Then
                    Dim _currencyID As String = oReader("CurrencyID")
                    compCurrency.SelectedItem.Selected = False
                    compCurrency.Items.FindByValue(_currencyID).Selected = True
                End If
                'end modification
        ...
        Dim objCustomerProfile As New CustomerProfile
        ...
        If objCustomerProfile.CheckTransaction(CustomerID) Then
            compCurrency.Enabled = False
        Else
            compCurrency.Enabled = True
        End If
    ...
    Sub UpdateProfile()
        ...
        Else
            ...
            '**************************************************************************
            'Muhammad Ubaid I've just commited following lines for error too many parameters
            ', txtECON.Text
            ...
            'False, compregno.Text, Now, Now, "Weekly", txtAccountOfficeReference.Text, 0, txtECON.Text)
            Dim m As Boolean = _objcustomerProfile.Update(CustomerID, street.Text, _
            compcity.Text, comppostcode.Text, compcountry.SelectedValue, compphone.Text, _
            compfax.Text, compemail.Text, cart_customer_state.Text, compname.Text, txtpayeofficeNo.Text, txtpayereference.Text, txtaccountRefarenceNo.Text, txtNINO.Text, complinbuss.Text, strCompYear, _
            False, compregno.Text, Now, Now, "Weekly", txtAccountOfficeReference.Text, 0)
            '******************************************************************************
            REM SR CR_00001
    ...
    Public Sub VerifyCustomerbyFH()
        ...
        If UKCompanyStatus = CompanyStatus.BothCompaniesHouseAndFormationsHouse Then
            ...
            Try
                ...
                Dim objProfile As New CustomerProfile
                Dim str() As String
    ...
    Private Sub FillCombo()
        ...
        With compCurrency
            ...
            '.DataSource = Infinilogic.AccountsCentre.DAL.SqlHelper.ExecuteDataset(0, CommandType.StoredProcedure, Infinilogic.AccountsCentre.DAL.SqlHelper.InfiniMainDB & "ACC_GetCurrencies").Tables(0)
            .DataSource = CustomerProfile.GetCurrencies()
            .DataBind()

            '.Items.FindByText("British pound 16 ( £ )").Selected = True
            .Items.FindByValue("196").Selected = True
        End With
        'modification end
    End Sub
    REM SR CR_00001
    ...
    Private Function VerifyFormData() As Boolean
        ...
        If Me.txtECON.Text <> "" AndAlso Not CommonBase.ValidCON(txtECON.Text, CON.ECON) Then strReturnMessage &= "<li>ECON</li>"
