	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE class="content" id="Table3" cellSpacing="0" cellPadding="0" width="449" border="0"
				...
				<TR>
					<TD style="WIDTH: 712px; HEIGHT: 18px" align="left"><STRONG><asp:Label id="lblsubject" runat="server" key="acc_message_lblsubject"></asp:Label></STRONG>
						<asp:textbox id="txtpsubject" runat="server" Width="557px" CssClass="mtbox"></asp:textbox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 712px; HEIGHT: 21px" align="left"><STRONG><asp:Label id="lblservice" runat="server" key="acc_message_lblservice"></asp:Label>
				...
				<TR>
					<TD style="WIDTH: 713px" align="right">
						<asp:checkbox id="chkSent" runat="server" CssClass="tx1" TextAlign="Left" key="acc_message_cbsent"
							Width="88px"></asp:checkbox>&nbsp;
						<asp:button id="btpostreply" onmouseover="this.className='MBUTTONON';" onmouseout="this.className='MBUTTON';"
							runat="server" CssClass="MBUTTON" key="acc_message_btnpost" Font-Bold="True"></asp:button>&nbsp;
						<input type="button" id="Close" onmouseover="this.className='MBUTTONON';" onmouseout="this.className='MBUTTON';"
							onclick="window.close();" Class="MBUTTON" Width="51px" key="acc_message_btnclose" runat="server"
							NAME="Close">&nbsp;&nbsp;</TD>
				</TR>
			</TABLE>
		</form>
