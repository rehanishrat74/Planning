										...
										<TR>
											<TD style="WIDTH: 612px; HEIGHT: 23px" align="right">
												<INPUT class="MBUTTON" onmouseover="this.className='MBUTTONON';" onclick="DeleteMessages()"
													onmouseout="this.className='MBUTTON';" type="button" runat="server" key="acc_btndelete"
													ID="Button1" NAME="Button1"> <INPUT id="allcheck" onclick="checkAll(this);" type="checkbox" name="allcheck"></TD>
										</TR>
										<TR>
										...
										<TR>
											<TD style="WIDTH: 612px" align="right">
												...
												<asp:button id="btpostreply" onmouseover="this.className='MBUTTONON';" onmouseout="this.className='MBUTTON';"
													runat="server" CssClass="MBUTTON" Runat="server" key="acc_message_btnpost/reply" Font-Bold="True"></asp:button></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
