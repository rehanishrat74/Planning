...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Trashbox.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.MessageTrashbox" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Accounts Centre - Messages - Trash Can</title>
									...
									<TABLE class="content" id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD style="WIDTH: 612px; HEIGHT: 23px" align="right">
												<INPUT class="MBUTTON" onmouseover="this.className='MBUTTONON';" onclick="RestoreMessages()"
													onmouseout="this.className='MBUTTON';" type="button" runat="server" key="acc_message_trashbox_btnrestore"
													ID="Button1" NAME="Button1"> <INPUT class="MBUTTON" onmouseover="this.className='MBUTTONON';" onclick="DeleteMessages()"
													onmouseout="this.className='MBUTTON';" type="button" runat="server" key="acc_btndelete" ID="Button2" NAME="Button2">
												<INPUT id="allcheck" onclick="checkAll(this);" type="checkbox" name="allcheck"></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 612px; HEIGHT: 1px" align="left"><STRONG><asp:Label id="lblsubject" runat="server" key="acc_message_lblsubject"></asp:Label>
												</STRONG>
												<asp:textbox id="txtpsubject" runat="server" Width="557px" CssClass="mtbox"></asp:textbox></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 612px; HEIGHT: 21px" align="left"><STRONG><asp:Label id="lblservice" runat="server" key="acc_message_lblservice"></asp:Label>
										...
										<TR>
											<TD style="WIDTH: 612px" align="right">
												<asp:checkbox id="chkSent" runat="server" CssClass="tx1" key="acc_message_cbsent" TextAlign="Left"></asp:checkbox>&nbsp;&nbsp;
												<asp:button id="btpostreply" onmouseover="this.className='MBUTTONON';" onmouseout="this.className='MBUTTON';"
													runat="server" CssClass="MBUTTON" key="acc_message_btnpost/reply" Font-Bold="True"></asp:button></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
