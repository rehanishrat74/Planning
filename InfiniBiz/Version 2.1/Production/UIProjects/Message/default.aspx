...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.MessageDefault" %>
					...
					<tr>
						<td id="contentarea" runat="server" width="95%">
							<TABLE class="content" id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
								...
								<TBODY>
									<TR>
										<TD id="menuarea" runat="server" vAlign="top" align="center" width=180><include:serviceslist id="ucServicesList" runat="server"></include:serviceslist></TD>
