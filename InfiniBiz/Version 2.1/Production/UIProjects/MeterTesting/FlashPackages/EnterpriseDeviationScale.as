...
//----------------------------------------------------------------------
class FlashPackages.EnterpriseDeviationScale {
	...
	function EnterpriseDeviationScale(Customerid, dateStart, dateEnd, LastStartDate, LastEndDate, getCurrency, meterName, meterType) {
		//trace("*** EnterpriseActualSpeedoMeter ***")
