...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BizPlan.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.BizPlan" %>
											...
											<table width="778" height="100%" border="0" align="center" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td height="97%" valign="top">
														<!--Multilingual -->
														<asp:label id="lblbizplan" runat="server" key="acc_products_bizplan_lblbizplan"></asp:label>
														<!--*******************-->
														</td>
