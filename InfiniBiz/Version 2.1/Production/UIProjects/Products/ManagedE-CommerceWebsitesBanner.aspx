...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManagedE-CommerceWebsitesBanner.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.ManagedE_CommerceWebsitesBanner" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Accounts Centre - ManagedE-CommerceWebBanner</title>
											...
											<table class="border_both_side" height="100%" cellSpacing="0" cellPadding="0" width="778"
												...
												<tr>
													<td vAlign="top" height="97%">
														<asp:Label ID="lblmanagedecommerce" Runat="server" key="acc_products_managede-commercewebsitesbanner_lblmanagede-commerce"></asp:Label>
													</td>
