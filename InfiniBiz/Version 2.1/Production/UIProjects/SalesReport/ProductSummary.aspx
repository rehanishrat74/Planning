...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProductSummary.aspx.vb" Inherits="accounts.infinibiz.Web.ProductSummary" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>accounts.infinibiz.com - Product Summary</title>
																				...
																				<tr vAlign="top">
																					<td vAlign="top" width="100%" colSpan="3" height="85%">
																						<asp:DataGrid ID="dgProduct" CssClass="TableBody" Runat="server" AutoGenerateColumns="False" Width="100%"
																							ShowFooter="True" EnableViewState="False" GridLines=Both>
																							...
																							<Columns>
																								<asp:HyperLinkColumn DataNavigateUrlField="code" DataNavigateUrlFormatString="/SalesReport/ProductSummaryDetails.aspx?ID={0}" DataTextField="code"
																									...
																									<HeaderStyle Wrap="False" HorizontalAlign="Left" Width="5%"></HeaderStyle>
																									<ItemStyle HorizontalAlign="Left" Width="10%"></ItemStyle>
																								</asp:HyperLinkColumn>
																								<asp:BoundColumn DataField="ProductName" HeaderText="Description">
																									<HeaderStyle Wrap="False" HorizontalAlign="Left" Width="30%"></HeaderStyle>
																									<ItemStyle HorizontalAlign="Left" Width="50%"></ItemStyle>
																								</asp:BoundColumn>
																								<asp:BoundColumn DataField="ByBank" HeaderText="By Bank" FooterText="Total" DataFormatString="{0:0.00}">
																									<HeaderStyle Wrap="False" HorizontalAlign="Right" Width="20%"></HeaderStyle>
