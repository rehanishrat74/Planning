...
#End Region
    ...
    Private RQry As String

    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Page.IsPostBack = False Then
            If Session("InfiniBizChildID") Is Nothing Then
                RQry = Request.QueryString("vmx")
                Session("InfiniBizChildID") = RQry
                dgProduct.DataSource = ObjUser.ProductSummaryDetail(Session("DCFROM"), Session("DCTO"), RQry)
                dgProduct.DataBind()
            Else
