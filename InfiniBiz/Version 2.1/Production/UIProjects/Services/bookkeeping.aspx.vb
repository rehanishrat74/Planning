...
Public Class Servicesbookkeeping
...
#End Region
    ...
    Private Sub Literal1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Literal1.Init
        If IsServiceAllowed("Express") Then
            Literal1.Text = "<br><a href='/Express/'><B>Infini Accounts Express</b></a>"
        End If
    End Sub

    Private Sub Literal2_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Literal2.Init
        If IsServiceAllowed("Express") Then
            Literal2.Text = "<br><a href='/Express/'><IMG title='Use Online Accounting' src='/images/logoExpress.jpg' border=0><a>"
        Else
            Literal2.Text = "<br><IMG title='Use Online Accounting' src='/images/logoExpress.jpg' border=0>"
        End If
    End Sub
