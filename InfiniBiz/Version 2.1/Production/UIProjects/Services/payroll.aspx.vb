...
#End Region
    ...
    Private Sub Literal1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Literal1.Init
        If IsServiceAllowed("Payroll") Then
            Literal1.Text = "<a href='/Payroll/'><B>Infini Payroll</b></a>"
        End If
    End Sub

    Private Sub Literal2_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Literal2.Init
        If IsServiceAllowed("Payroll") Then
            Literal2.Text = "<br><a href='/Payroll/'><IMG title='Use Online Accounting' src='/images/logo-Payroll.jpg' border=0><a>"
        Else
            Literal2.Text = "<br><IMG title='Use Online Accounting' src='/images/logo-Payroll.jpg' border=0>"
        End If
    End Sub
