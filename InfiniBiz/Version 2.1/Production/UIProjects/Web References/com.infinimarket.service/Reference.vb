...
Namespace com.infinimarket.service
    ...
    Public Class _Default
        ...
        Public Function isSignIn(ByVal sXml As String) As String
            Dim results() As Object = Me.Invoke("isSignIn", New Object() {sXml})
            Return CType(results(0),String)
        End Function
        
        '<remarks/>
        Public Function BeginisSignIn(ByVal sXml As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("isSignIn", New Object() {sXml}, callback, asyncState)
        End Function
