...
#Region "Settings according to user input"
    ...
    Private Sub SetQuerySettingsList()
        ...
        Dim intCall As Integer = CType(HttpContext.Current.Session("CALL"), Integer)
        ...
        ElseIf intCall = 1 Then

            QuerySettings.Add(PlanQueries.businessType, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.businessType).Item(0))), businessPlan.BusinessGoods.ToString())
            QuerySettings.Add(PlanQueries.manageInventory, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.manageInventory).Item(0))), businessPlan.ManageInventory.ToString())
            If businessPlan.ManageInventory Then QuerySettings.Add(PlanQueries.inventoryTurnover, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.inventoryTurnover).Item(0))), businessPlan.InventoryTurnover.ToString())
            QuerySettings.Add(PlanQueries.sellOnCredit, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.sellOnCredit).Item(0))), businessPlan.SellOnCredit.ToString())
            If businessPlan.SellOnCredit Then QuerySettings.Add(PlanQueries.salesOnCredit, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.salesOnCredit).Item(0))), businessPlan.SalesOnCreditPercent.ToString())
            If businessPlan.SellOnCredit Then QuerySettings.Add(PlanQueries.collectionDays, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.collectionDays).Item(0))), businessPlan.CollectionPeriod.ToString())
            If businessPlan.BusinessGoods = BusinessGoodsType.Products Or businessPlan.BusinessGoods = BusinessGoodsType.Both Then QuerySettings.Add(PlanQueries.salesForcastType, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.salesForcastType).Item(0))), businessPlan.SalesForecastType.ToString())
            QuerySettings.Add(PlanQueries.categorizedExpense, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.categorizedExpense).Item(0))), businessPlan.DisplayExpense.ToString())
            QuerySettings.Add(PlanQueries.personalBurden, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.personalBurden).Item(0))), businessPlan.PersonnelBurden.ToString())
            QuerySettings.Add(PlanQueries.shortTermInterestRate, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.shortTermInterestRate).Item(0))), businessPlan.ShortTermInterestRate.ToString())
            QuerySettings.Add(PlanQueries.longTermInterestRate, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.longTermInterestRate).Item(0))), businessPlan.LongTermInterestRate.ToString())
            QuerySettings.Add(PlanQueries.taxRate, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.taxRate).Item(0))), businessPlan.EstimatedTaxRate.ToString())
            QuerySettings.Add(PlanQueries.nonPayrollExpense, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.nonPayrollExpense).Item(0))), businessPlan.NonPayrollCashExpense.ToString())
            QuerySettings.Add(PlanQueries.paymentDays, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.paymentDays).Item(0))), businessPlan.PaymentDays.ToString())
            If businessPlan.IsOngoing Then
                QuerySettings.Add(PlanQueries.startupOrOngoing, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.startupOrOngoing).Item(0))), _resMgr.GetString("PW_" & CStr(ds.Tables(0).Rows(PlanQueries.startupOrOngoing).Item(0)) & "_Ongoing"))
            Else
                QuerySettings.Add(PlanQueries.startupOrOngoing, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.startupOrOngoing).Item(0))), _resMgr.GetString("PW_" & CStr(ds.Tables(0).Rows(PlanQueries.startupOrOngoing).Item(0)) & "_Startup"))
            End If
            QuerySettings.Add(PlanQueries.Currency, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.Currency).Item(0))), businessPlan.Currency)
            QuerySettings.Add(PlanQueries.planStartDate, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.planStartDate).Item(0))), businessPlan.StartMonth.ToString() & " " & businessPlan.StartYear.ToString())
            'QuerySettings.Add(PlanQueries.standardOrLongTerm, _resMgr.GetString(_resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.standardOrLongTerm).Item(0)))), businessPlan.StandardOrLongTerm.ToString())
            QuerySettings.Add(PlanQueries.planTitle, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.planTitle).Item(0))), businessPlan.PlanName)
            QuerySettings.Add(PlanQueries.planDescription, _resMgr.GetString("PW_Title_" & CStr(ds.Tables(0).Rows(PlanQueries.planDescription).Item(0))), businessPlan.BusinessDescription)
