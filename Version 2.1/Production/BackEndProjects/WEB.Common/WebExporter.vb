...
#Region "............... Private Members "
    ...
    Private _chartExporter As WebChartExporter
...
#Region "................... Private Methods "
    ...
    Private Function Export() As String
        ...
        _chartExporter = New WebChartExporter(connData, currentPlan)


        Dim ds As DataSet = TextOperations.GetPlanTextHeadings(connData, currentPlan)
    ...
    Private Sub PrepareTOC(ByRef headingRows As Array, ByRef headingsTable As DataTable, ByRef sb As StringBuilder)
    ...
    Private Sub PrepareRTFs(ByRef headingRows As Array, ByRef headingsTable As DataTable, ByRef sb As StringBuilder)
        ...
        For Each dr In headingRows
            ...
            Try
                ...
                If (CInt(dr("HeadingType")) = 0) Then
                    ...
                    htmlString = TextOperations.GetPlanTextData(connData, currentPlan, CInt(dr("HeadingID")))
                    rtfString = Html2RtfConvertor.TransformIntoRTF(heading & htmlString, _xslPath, GetStylesheetParams())
