...
#Region ":::::::::::::::: Helper Functions and Procedures ::::::::::::::::"
    ...
    Private Function CustomerDetail()
        ...
        Else
            ...
            strServiceStatus = objCXL.RepaymentCXL(strReturn, OrderNo, intCustomerID, strCardType, strCardNo, _
        ...
        If intCustomerID <> 0 Then
            ...
            isRetryPayment = CallCXLProcessing(intCustomerID, strPaymentMode)
            ...
            If Not Session("ACC_GV_RegistrationMode") = RegistrationMode.MemberOfGlobalView Then
                ...
                If CommonBase.SendEmail(ConfigReader.GetItem(ConfigVariables.SMTPUserID), _
                    ...
                    EmailManager.CreatDBLog(intCustomerID, "ACSA", strBody.ToString, strInvoiceName, strTo.ToString, strSubject.ToString, ConfigReader.GetItem(ConfigVariables.SMTPUserID), True)
                Else
                    ...
                    EmailManager.CreatDBLog(intCustomerID, "ACSA", strBody.ToString, strInvoiceName, strTo.ToString, strSubject.ToString, ConfigReader.GetItem(ConfigVariables.SMTPUserID), False)
                End If
...
#Region ":::::::::::::::: CXL Implementation ::::::::::::::::"
    ...
    Private Function CallCXLProcessing(ByVal CustomerID As Integer, ByVal PaymentMode As String) As Boolean
        If PaymentMode = "CC" Then
            ...
            ' Get OrderNo
            'Try
            OrderNo = objCXL.GetOrderNo(CustomerID)
            ...
            Return objCXL.CheckCollectionStatus(CustomerID, strUID, OrderNo, strStatusCXL, PaymentMode)
            '------------------------------------------------------------------------------------------------------------
        End If
