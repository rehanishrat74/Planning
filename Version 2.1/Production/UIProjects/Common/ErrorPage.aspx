						...
						<TABLE id="Table1" cellSpacing="5" cellPadding="5" width="100%" border="0">
							<TR>
								<TD vAlign="top" height="29">
									<asp:Label id="lblErrorHeading" runat="server" CssClass="acc_error_heading">We are incurring technical difficulties in loading this page.</asp:Label></TD>
							</TR>
							<TR>
								<TD vAlign="top"><FONT size="2">
										<P>
											<asp:Label id="lblErrorText" runat="server" CssClass="acc_error_text">We apologise for this error as we could not comply with your request. A notification of this error has been sent to our systems administrators who are already working to resolve this problem.
