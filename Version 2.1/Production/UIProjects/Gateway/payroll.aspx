...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="payroll.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.GatewaysPayroll" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Accounts Centre - Inland Revenue Gateway - Payroll</title>
							...
							<TR>
								...
								<TD id="gatewayarea" runat="server" vAlign="top" align="left" width="80%">
									...
									<TABLE class="content" id="Table5" cellSpacing="0" cellPadding="0" width="550" border="0">
										<TR>
											<TD style="HEIGHT: 9px" colspan="2" class="acc_header_backgrounds">&nbsp;PAYE and NIC</TD>
										</TR>
										<TR>
											<TD width="4" style="HEIGHT: 9px"></TD>
											<TD valign="top" style="HEIGHT: 17px"><br>
												<P>Welcome to the Gateway registration service for Payroll. This service has been 
													designed to register your company with the Government Gateway in order to 
													facilitate timely submission of PAYE forms and documents via electronic filing. 
													Accounts Centre gives you a quicker method to register with the Government 
													Gateway, and using our services to efile forms and information regularly to the 
													Inland Revenue database.
												</P>
												<P>All you have to do is place a request, and verify that the information provided 
													on your user profile is correct, because your registration will depend on the 
													accuracy of the information provided. Place Gateway registration request now. 
													If you are already a registered with the Gateway, you can sign us up as your 
													Agents for processing Payroll electronically.
												</P>
												<P><table border="0">
														<tr>
												...
												<P>For more information on registering for Gateway through Accounts Centre 
													automated services, <a style="CURSOR:hand" onclick="OpenMessagePopup();" onmousemove="this.className='ONLINK';"
														onmouseout="this.className='';"><b>click here</b></a>.</P>
											</TD>
										</TR>
										<TR>
...
window.navigate ("/gateway/payroll.aspx?ACT=REQ");
}
		</script>
	</body>
</HTML>
