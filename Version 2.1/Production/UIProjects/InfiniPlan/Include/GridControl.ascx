...
<table class="tablebackground" cellSpacing="0" cellPadding="0" width="422" align="left"
	...
	<TR>
		<TD colSpan="2" height="20%">
			<DIV class="GridControl" id="gridDiv1"><asp:datagrid id="dgProducts" CssClass="pagecontents" Runat="server" AutoGenerateColumns="True"
					GridLines="Both" AllowPaging="True" CellPadding="1" CellSpacing="0" EnableViewState="True" Width="100%">
					...
					<Columns>
						<asp:TemplateColumn FooterStyle-Height="17px" HeaderStyle-Width="17px" ItemStyle-Width="17px">
							<ItemTemplate>
	...
	<TR>
		<TD align="right" colSpan="2"><include:gridnavigator id="gnavigator" runat="server"></include:gridnavigator></TD>
	</TR>
	<TR>
