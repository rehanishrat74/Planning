						...
						<td vAlign="top" height="100%">
							<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
																							...
																							<TABLE height="10%" width="100%" border="0">
																								<TR vAlign="middle">
																									<TD vAlign="middle" align="center" height="80%">
																										<ASP:LABEL id="Heading" runat="server" Width="70%" Height="35px" cssclass="wizardHeader">InfiniPlan Analysis 
                                Wizard</ASP:LABEL></TD>
																								</TR>
																								<TR vAlign="middle">
																									<TD vAlign="middle" align="center" height="20%">
																										<ASP:LABEL id="Title" runat="server" Width="70%" cssclass="wizardTitle"></ASP:LABEL></TD>
																								</TR>
																							</TABLE>
																						</ASP:PANEL>
																																...
																																<TR vAlign="top">
																																	<TD vAlign="top" align="center" width="40%" height="5%">
																																		...
																																		<ASP:BUTTON id="btnSelect" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																																			runat="server" Visible="False" Text="Select" Cssclass="MBUTTONACCPRO"></ASP:BUTTON>
															...
															<TR height="5%">
																...
																<TD>
																	<ASP:BUTTON id="btnShow" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																		runat="server" Text="Save" Cssclass="MBUTTONACCPRO" Enabled="False"></ASP:BUTTON>
																	<ASP:BUTTON id="viewGraph" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																		runat="server" Visible="False" Text="View MyClip" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></TD>
															</TR>
															...
															<TR vAlign="bottom">
																<TD align="center" height="95%">
																	<TABLE height="98%" width="97%" align="center" border="0">
																		<TR vAlign="top">
																			<TD align="center">
																				<ASP:PANEL id="PanelListingforClips" CssClass="tableborder" Width="100%" Runat="server" height="100%"
																					visible="True">
																					<TABLE height="100%" width="100%" align="center" border="0">
																						<TR vAlign="top">
                                ...
                                below of any one </ASP:LABEL><BR>
																								<BR>
																								<ASP:PANEL id="Panel3" CssClass="tableborder" Width="90%" Runat="server" height="88%" visible="True">
																									<TABLE border="0">
																										<TR>
																											<TD align="center">
																										...
																										<TR>
																											<TD>
																												<DIV class="MeterList" id="divViews" align="center">
																													<IEWC:TREEVIEW id="TreeView1" tabIndex="5" runat="server" AutoPostBack="True" HoverStyle="filter=none;background-color:#ECF4FC;"
																							...
																							<TBODY>
																								<TR vAlign="top">
																									<TD align="center" width="100%" height="100%">
																										<DIV class="meterSpavetest" id="maindiv">
