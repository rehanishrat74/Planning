...
<HTML xmlns:o xmlns:u1>
	<HEAD>
		...
		<!--<script src="../../Library/Scripts/ieBug.js"></script>-->
																									...
																									<TABLE height="10%" width="100%" border="0">
																										<TR vAlign="middle">
																											<TD vAlign="middle" align="center" height="80%">
																												<ASP:LABEL id="Heading" runat="server" Width="71%" Height="35px" cssclass="wizardHeader">InfiniPlan Analysis 
                                Wizard</ASP:LABEL></TD>
																										</TR>
																										<TR vAlign="middle">
																											<TD vAlign="middle" align="center" height="20%">
																												<ASP:LABEL id="Title" runat="server" Width="71%" cssclass="wizardTitle"></ASP:LABEL></TD>
																										</TR>
																									</TABLE>
																								</ASP:PANEL>
																	...
																	<TR vAlign="top" width="100%">
																		<TD align="center" width="100%" height="97%">
																			<TABLE height="100%" width="100%" align="center" border="0">
																				<TR vAlign="top">
																					<TD align="center">
																						<ASP:PANEL id="PanelListingforClips" CssClass="tableborder" Width="100%" Runat="server" visible="True">
																							<TABLE height="100%" width="100%" align="center" border="0">
																								<TR vAlign="top">
																									<TD align="center" width="80%">
																										<ASP:PANEL id="Panel3" CssClass="tableborder" Width="100%" Runat="server" visible="True">
																											<TABLE border="0">
																												<TR vAlign="top">
																													<TD>
																									...
																									<TD vAlign="top" align="center" width="25%" rowSpan="2">
																										...
																										<ASP:PANEL id="PanelZoom" CssClass="tableborder1" Width="100%" Visible="True" Runat="server"
																												...
																												<TR vAlign="top" height="10%">
																													<TD align="center">
																														<ASP:BUTTON id="imgbtnAdv" onmouseover="this.className='MBUTTONACCPROON';" onmouseout="this.className='MBUTTONACCPRO';"
																															runat="server" Visible="False" Text="Advance" Cssclass="MBUTTONACCPRO"></ASP:BUTTON></TD>
																												</TR>
																											</TABLE>
																										</ASP:PANEL></TD>
																								<TR>
																										...
																										<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="190" border="0">
																											<TR>
																												<TD align="center" width="25%">
																													<ASP:IMAGEBUTTON id="editmeter" runat="server" Visible="True" ImageUrl="/images/infiniplan/editmeter.jpg"
																														ToolTip="Edit"></ASP:IMAGEBUTTON></TD>
																												<TD align="center" width="25%">
																													<ASP:IMAGEBUTTON id="zoommeter" runat="server" Visible="True" ImageUrl="/images/infiniplan/zoommeter.jpg"
																														ToolTip="Zoom"></ASP:IMAGEBUTTON></TD>
																												<TD align="center" width="25%">
																												...
																												<TD align="center" width="25%">
																													<ASP:IMAGEBUTTON id="deletemter" runat="server" Visible="True" ImageUrl="/images/infiniplan/deletemter.jpg"
