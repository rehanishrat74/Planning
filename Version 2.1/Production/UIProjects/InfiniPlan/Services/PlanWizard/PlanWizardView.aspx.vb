...
#Region "Event Handlers"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Page.IsPostBack Then
            'new plan is creating & finished button is clicked 
            'or
            'user is in plan by buttons  
        ...
        Else
            ...
            Else
                ...
                Else
                    'New Plan is creating after click at new plan 
    ...
    Public Sub UI(ByVal planid As String)

        'bool = ObjPlan.BasePlanIDCheck(GetConnectionData, planid)
        'If bool = True Then
...
#Region "Private Helper Mehods"
    ...
    Private Sub UpdateView()
        ...
        If query.ViewType = QuestionTypes.text Then
            ...
            If bool = True Then
                If query.ViewID = PlanQueries.planTitle Then
