<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="InfiniLogic.AccountsCentre.Web.InfoDeskDefault" %>
...
<HTML>
	<HEAD>
		<title>Accounts Centre - Info Desk</title>
		<meta name="cbwords" content='Information,Tax Updates,Newsletter,News,New Services'>
					...
					<td id="contentarea" runat="server" width="95%" valign="top">
						<TABLE class="content" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								...
								<TD id="membersarea" runat="server" vAlign="top" align="left" class="content" width="95%">
								</TD>
							</TR>
						</TABLE>
					</td>
