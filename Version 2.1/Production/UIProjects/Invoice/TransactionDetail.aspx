	...
	<body id="htmlContentBody" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0"
		...
		<form id="formTransactionDetail" method="post" runat="server">
			<table class="CONTENT" id="layouttable" height="100%" cellSpacing="0" cellPadding="0" width="100%"
				...
				<tr vAlign="top">
					<td vAlign="top">
						<table border="0" class="content" cellpadding="0" cellspacing="0" width="100%">
							<tr>
																...
																<ItemTemplate>
																	<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content">
																		<tr>
																			...
																			<td width="20%" align="center"><a href="#_self2" onclick="javascript:loadPDF(0,'<%# DataBinder.Eval(Container.DataItem,"OrderNo") %>','N');"><img src="/images/download.gif" border=0></a>
																			</td>
																		</tr>
																	</table>
																</ItemTemplate>
																...
																<ItemTemplate>
																	<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content">
																		<tr>
																			...
																			<td width="20%" align="center"><a href="#_self1" onclick="javascript:loadPDF('<%# DataBinder.Eval(Container.DataItem,"OrderNo") %>','<%# DataBinder.Eval(Container.DataItem,"InvoiceNo") %>','Y');"><img src="/images/download.gif" border=0></a>
																			</td>
																		</tr>
																	</table>
																</ItemTemplate>
