				...
				<td vAlign="top">
					<table border="0" class="content" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<td width="3">&nbsp;</td>
							<td valign="top"><table class="content" cellSpacing="0" cellPadding="0" width="600" border="0">									
									<tr>
										<TD colSpan="2" width="600" align="center" class="info">
											<!--BEGIN INFORMATION PANEL --><asp:panel id="pnlInformation" runat="server" Width="601px" Visible="False">
								...
								<!-- BEGIN OF SPECIFIC ORDER DETAILS PANEL --><asp:panel id="pnlOrder" Width="600" Runat="server" Visible="False" Wrap="True">
									<TABLE class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD align="center">
												<asp:DataGrid id="dgrdOrder" Width="600" Runat="server" AutoGenerateColumns="False">
													<Columns>
														<asp:TemplateColumn>
															<HeaderTemplate>
																<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content">
								...
								<table class="content" cellSpacing="0" cellPadding="0" width="600" border="0">
									<tr>
										<td align="right" width=100%><A class="LINK_BLUE" href="javascript:javascript:history.back();">&lt; 
												Back</A></td>
									</tr>
									<tr>
										<td colSpan="2" height="5"></td>
